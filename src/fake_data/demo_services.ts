...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the JAVIS Home service.", fields: {} },
    restart: { description: "Restart the JAVIS Home service.", fields: {} },
    check_config: {
      description:
        "Check the JAVIS Home configuration files for errors. Errors will be displayed in the JAVIS Home log.",
      fields: {},
    },
    update_entity: {
