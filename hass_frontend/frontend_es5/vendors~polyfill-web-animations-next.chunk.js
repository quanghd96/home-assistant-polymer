(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["vendors~polyfill-web-animations-next"],
  {
          ...
          !(function(a, b) {
                  ...
                  _discardAnimations: function _discardAnimations() {
                    this._updateAnimationsPromises(),
                      (this._animations = this._animations.filter(function(a) {
                        return (
                          "finished" != a.playState && "idle" != a.playState
                        );
                      }));
                  },
              ...
              (b.animationsWithPromises = []),
                ...
                (b.Animation.prototype = {
                  ...
                  _arrangeChildren: function _arrangeChildren(a, b) {
                    null === this.startTime
                      ? (a.currentTime =
                          this.currentTime - b / this.playbackRate)
                      : a.startTime !==
                          this.startTime + b / this.playbackRate &&
            ...
            (function(a, b, c) {
              ...
              var f = function f(a) {
                if (
                  ((a._animation = void 0),
                  a instanceof window.SequenceEffect ||
                    a instanceof window.GroupEffect)
                )
              ...
              (b.removeMulti = function(a) {
                for (var b = [], c = 0; c < a.length; c++) {
                  ...
                  d._parent
                    ? (-1 == b.indexOf(d._parent) && b.push(d._parent),
                      d._parent.children.splice(
                        d._parent.children.indexOf(d),
                        1
                      ),
                      (d._parent = null),
                      f(d))
                ...
                (b.KeyframeEffect = function(b, c, e, f) {
                  return (
                    ...
                    (this._keyframes = c),
                    (this.activeDuration = a.calculateActiveDuration(
                      this._timing
                    )),
                    (this._id = f),
                    this
                ...
                (b.KeyframeEffect.prototype = {
                  ...
                  clone: function clone() {
                    if ("function" == typeof this.getFrames())
                      throw new Error(
                        "Cloning custom effects is not supported."
                      );
                ...
                var j = function j() {
                  ...
                  null !== d &&
                    ...
                    d !== i &&
                      (g
                        ? c(d, e, b.effect)
                        : c(d, b.effect, b.effect._animation)),
                    (i = d);
                };
                ...
                (e.prototype = {
                  ...
                  _putChild: function _putChild(a, b) {
                    ...
                    for (var d = 0; d < a.length; d++) {
                      b
                        ? this.children.push(a[d])
                        : this.children.unshift(a[d]);
                    }
