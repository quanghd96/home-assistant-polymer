...
*/
  ...
  \*************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _components_dialog_ha_paper_dialog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../../components/dialog/ha-paper-dialog */ "./src/components/dialog/ha-paper-dialog.ts"
        );
        /* harmony import */ var _resources_styles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        var DomainTogglerDialog = _decorate(
          [
              ...
              d: [
                ...
                },
                {
                  ...
                  value: function render() {
                    ...
                    var domains = this._params.domains
                      .map(function(domain) {
                        return [
                          _this2.hass.localize("domain.".concat(domain)),
                          domain,
                        ];
                      })
                      .sort();
                    ...
                    return Object(
                      ...
                      domains.map(function(domain) {
                        return Object(
                          lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]
                        )(_templateObject3(), domain[0], domain[1], _this2._handleOff, _this2.hass.localize("state.default.off"), domain[1], _this2._handleOn, _this2.hass.localize("state.default.on"));
                      })
                    );
                  },
                },
                ...
                },
                {
                  ...
                  value: function styles() {
                    return [
                      _resources_styles__WEBPACK_IMPORTED_MODULE_2__[
                        "haStyleDialog"
                      ],
