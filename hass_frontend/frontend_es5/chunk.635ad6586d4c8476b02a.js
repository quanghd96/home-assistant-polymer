/*! For license information please see chunk.635ad6586d4c8476b02a.js.LICENSE */
(window.webpackJsonp = window.webpackJsonp || []).push([
  [118],
  {
    117: function(e, n, t) {
      ...
      var a = t(53),
        r = t(34),
        i = [a.a, r.a, { hostAttributes: { role: "option", tabindex: "0" } }];
    },
    138: function(e, n, t) {
      "use strict";
      t(4), t(44), t(140);
    ...
    178: function(e, n, t) {
      ...
      Object(a.a)({ _template: Object(r.a)(i()), is: "paper-item-body" });
    },
    204: function(e, n, t) {
      "use strict";
      t(4), t(83);
    ...
    230: function(e, n, t) {
      ...
      var h = Object(s.a)(c());
      h.setAttribute("strip-whitespace", ""),
        Object(l.a)({
          _template: h,
          is: "paper-fab",
          behaviors: [o],
      ...
      Object(a.a)({
        ...
        __routeQueryParamsChanged: function(e) {
          if (e && this.tail) {
            ...
            for (var a in e)
              (n[a] = e[a]),
                (!t && this.queryParams && e[a] === this.queryParams[a]) ||
                  (t = !0);
        ...
        __tryToMatch: function() {
          if (this.route) {
            var e = this.route.path,
              n = this.pattern;
            if ((this.autoActivate && "" === e && (e = "/"), n))
              if (e) {
                for (
                  var t = e.split("/"), a = n.split("/"), r = [], i = {}, p = 0;
                  p < a.length;
                  p++
                ) {
                  var o = a[p];
                  ...
                  if ((r.push(l), ":" == o.charAt(0))) i[o.slice(1)] = l;
                  else if (o !== l) return void this.__resetProperties();
                }
                this._matched = r.join("/");
                var s = {};
                this.active || (s.active = !0);
                var c = this.route.prefix + this._matched,
                  h = t.join("/");
                for (var d in (t.length > 0 && (h = "/" + h),
                (this.tail && this.tail.prefix === c && this.tail.path === h) ||
                  (s.tail = {
                    prefix: c,
                    path: h,
        ...
        __tailPathChanged: function(e) {
          if (this.active) {
            var n = e,
              t = this._matched;
            n && ("/" !== n.charAt(0) && (n = "/" + n), (t += n)),
              this.set("route.path", t);
          }
        },
        ...
        __getLink: function(e) {
          var n = { tail: null };
          for (var t in this.data) n[t] = this.data[t];
          for (var t in e) n[t] = e[t];
          var a = this.pattern.split("/").map(function(e) {
            return ":" == e[0] && (e = n[e.slice(1)]), e;
          }, this);
          return (
            n.tail &&
              n.tail.path &&
              (a.length > 0 && "/" === n.tail.path.charAt(0)
                ? a.push(n.tail.path.slice(1))
                : a.push(n.tail.path)),
            a.join("/")
          );
        },
        __setMulti: function(e) {
          for (var n in e) this._propertySetter(n, e[n]);
          void 0 !== e.data &&
      ...
      var a = t(14),
        ...
        p = Object(r.f)(function() {
          ...
          return function(e) {
            var t = i.get(e);
            void 0 === t &&
              ((t = { lastRenderedIndex: 2147483647, values: [] }),
              i.set(e, t));
            var r = t.values,
              p = r.length;
            t.values = n;
            var o = function(i) {
              if (i > t.lastRenderedIndex) return "break";
              var o = n[i];
              return Object(a.h)(o) || "function" != typeof o.then
                ? (e.setValue(o), (t.lastRenderedIndex = i), "break")
                : i < p && o === r[i]
                ? "continue"
                : ((t.lastRenderedIndex = 2147483647),
                  (p = 0),
                  void Promise.resolve(o).then(function(n) {
                    var a = t.values.indexOf(o);
                    a > -1 &&
                      a < t.lastRenderedIndex &&
                      ((t.lastRenderedIndex = a), e.setValue(n), e.commit());
                  }));
            };
...
//# sourceMappingURL=chunk.635ad6586d4c8476b02a.js.map
