        ...
        var HaDialogShowAudioMessage =
          ...
          (function(_LocalizeMixin) {
            ...
            function HaDialogShowAudioMessage() {
              ...
              return _possibleConstructorReturn(
                this,
                _getPrototypeOf(HaDialogShowAudioMessage).apply(this, arguments)
              );
            }

            _createClass(
              HaDialogShowAudioMessage,
              [
                {
                  key: "showDialog",
                  value: function showDialog(_ref) {
                    ...
                    if (platform.has_media) {
                      ...
                      mp3.src = null;
                      var url = "/api/mailbox/media/"
                        .concat(platform.name, "/")
                        .concat(message.sha);
                      this.hass
                        .fetchWithAuth(url)
                        ...
                        .catch(function(err) {
                          ...
                          _this._errorMsg = "Error loading audio: ".concat(
                            err.statusText
                          );
                        });
                    } else {
