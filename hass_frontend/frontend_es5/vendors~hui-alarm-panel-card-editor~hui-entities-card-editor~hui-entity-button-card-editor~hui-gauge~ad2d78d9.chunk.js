  ...
  \**************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
          ...
          (function(_TypeError) {
            ...
            _createClass(StructError, null, [
              {
                ...
                value: function format(attrs) {
                  var type = attrs.type,
                    path = attrs.path,
                    value = attrs.value;
                  var message = "Expected a value of type `"
                    .concat(type, "`")
                    .concat(
                      path.length ? " for `".concat(path.join("."), "`") : "",
                      " but received `"
                    )
            ...
            function StructError(attrs) {
              ...
              _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(StructError).call(this, message)
              );
              var data = attrs.data,
                path = attrs.path,
                value = attrs.value,
        ...
        function any(schema, defaults$$1, options) {
          ...
          switch (kindOf(schema)) {
            case "array": {
              return schema.length > 1
                ? tuple(schema, defaults$$1, options)
                : list(schema, defaults$$1, options);
            }
          ...
          if (true) {
            throw new Error(
              "A schema definition must be an object, array, string or function, but you passed: ".concat(
                schema
              )
            );
          } else {
        ...
        function dict(schema, defaults$$1, options) {
          if (kindOf(schema) !== "array" || schema.length !== 2) {
            if (true) {
              throw new Error(
                "Dict structs must be defined as an array with two elements, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function en(schema, defaults$$1, options) {
          if (kindOf(schema) !== "array") {
            if (true) {
              throw new Error(
                "Enum structs must be defined as an array, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function func(schema, defaults$$1, options) {
          if (kindOf(schema) !== "function") {
            if (true) {
              throw new Error(
                "Function structs must be defined as a function, but you passed: ".concat(
                  schema
                )
              );
            } else {
          ...
          var validate = function validate() {
            ...
            switch (kindOf(result)) {
              ...
              default: {
                if (true) {
                  throw new Error(
                    "Validator functions must return a boolean, an error reason string or an error reason object, but you passed: ".concat(
                      schema
                    )
                  );
                } else {
        ...
        function inter(schema, defaults$$1, options) {
          if (kindOf(schema) !== "object") {
            if (true) {
              throw new Error(
                "Interface structs must be defined as an object, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function lazy(schema, defaults$$1, options) {
          if (kindOf(schema) !== "function") {
            if (true) {
              throw new Error(
                "Lazy structs must be defined as an function that returns a schema, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function dynamic(createSchema, defaults$$1, options) {
          if (kindOf(createSchema) !== "function") {
            if (true) {
              throw new Error(
                "Dynamic structs must be defined as a function, but you passed: ".concat(
                  createSchema
                )
              );
            } else {
          ...
          var validate = function validate() {
            ...
            if (kindOf(schema) !== "function") {
              if (true) {
                throw new Error(
                  "Dynamic structs must return a schema, but you passed: ".concat(
                    schema
                  )
                );
              } else {
        ...
        function list(schema, defaults$$1, options) {
          if (kindOf(schema) !== "array" || schema.length !== 1) {
            if (true) {
              throw new Error(
                "List structs must be defined as an array with a single element, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function object(schema, defaults$$1, options) {
          if (kindOf(schema) !== "object") {
            if (true) {
              throw new Error(
                "Object structs must be defined as an object, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function partial(schema, defaults$$1, options) {
          if (kindOf(schema) !== "object") {
            if (true) {
              throw new Error(
                "Partial structs must be defined as an object, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function scalar(schema, defaults$$1, options) {
          if (kindOf(schema) !== "string") {
            if (true) {
              throw new Error(
                "Scalar structs must be defined as a string, but you passed: ".concat(
                  schema
                )
              );
            } else {
          ...
          if (kindOf(fn) !== "function") {
            if (true) {
              throw new Error(
                'No struct validator function found for type "'.concat(
                  schema,
                  '".'
                )
              );
        ...
        function tuple(schema, defaults$$1, options) {
          if (kindOf(schema) !== "array") {
            if (true) {
              throw new Error(
                "Tuple structs must be defined as an array, but you passed: ".concat(
                  schema
                )
              );
            } else {
        ...
        function union(schema, defaults$$1, options) {
          if (kindOf(schema) !== "array") {
            if (true) {
              throw new Error(
                "Union structs must be defined as an array, but you passed: ".concat(
                  schema
                )
              );
            } else {
          ...
          var validate = function validate() {
            ...
            try {
              for (
                var _iterator = kinds[Symbol.iterator](), _step;
        ...
        function intersection(schema, defaults$$1, options) {
          if (kindOf(schema) !== "array") {
            if (true) {
              throw new Error(
                "Intersection structs must be defined as an array, but you passed: ".concat(
                  schema
                )
              );
            } else {
          ...
          var validate = function validate() {
            ...
            try {
              for (
                var _iterator2 = types[Symbol.iterator](), _step2;
