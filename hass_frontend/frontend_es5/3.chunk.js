...
*/
        ...
        var DisableUpgradeMixin = Object(
            ...
            (function(_superClass) {
              ...
              function DisableUpgradeClass() {
                ...
                return _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(DisableUpgradeClass).apply(this, arguments)
                );
              }
                    ...
                    value: function attributeChangedCallback(
                      ...
                      if (name == DISABLED_ATTR) {
                        if (
                          ...
                          _get(
                            _getPrototypeOf(DisableUpgradeClass.prototype),
                            "connectedCallback",
                            this
                          ).call(this);
                        }
                        ...
                        _get(
                          ...
                          this
                        ).call(this, name, old, value, namespace);
                      }
                    },
                    /*
      ...
      */
                  ...
                  },
                  {
                    ...
                    value: function connectedCallback() {
                      if (
                        this.__dataEnabled ||
                        !this.hasAttribute(DISABLED_ATTR)
                      ) {
                        _get(
                          _getPrototypeOf(DisableUpgradeClass.prototype),
                          "connectedCallback",
                ...
                [
                  {
                    ...
                    get: function get() {
                      return _get(
                        _getPrototypeOf(DisableUpgradeClass),
                        "observedAttributes",
                        this
                      ).concat(DISABLED_ATTR);
                    },
                  },
                ]
              );
        ...
        var Lumo =
          ...
          (function(_HTMLElement) {
            ...
            function Lumo() {
              ...
              return _possibleConstructorReturn(
                this,
                _getPrototypeOf(Lumo).apply(this, arguments)
              );
            }
          ...
          (function(_ThemableMixin) {
            ...
            function OverlayElement() {
              ...
              _this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(OverlayElement).call(this)
              );
              _this._boundMouseDownListener = _this._mouseDownListener.bind(
                _assertThisInitialized(_this)
              );
              _this._boundMouseUpListener = _this._mouseUpListener.bind(
                _assertThisInitialized(_this)
              );
              _this._boundOutsideClickListener = _this._outsideClickListener.bind(
                _assertThisInitialized(_this)
              );
              _this._boundKeydownListener = _this._keydownListener.bind(
                _assertThisInitialized(_this)
              );
              _this._observer = new _polymer_polymer_lib_utils_flattened_nodes_observer_js__WEBPACK_IMPORTED_MODULE_3__[
                "FlattenedNodesObserver"
              ](_assertThisInitialized(_this), function(info) {
                _this._setTemplateFromNodes(info.addedNodes);
              }); // Listener for preventing closing of the paper-dialog and all components extending `iron-overlay-behavior`.

              _this._boundIronOverlayCanceledListener = _this._ironOverlayCanceled.bind(
                _assertThisInitialized(_this)
              );
              ...
              [
                {
                  ...
                  value: function ready() {
                    _get(
                      _getPrototypeOf(OverlayElement.prototype),
                      "ready",
                      this
                    ).call(this);
                  ...
                  value: function _animatedOpening() {
                    ...
                    var finishOpening = function finishOpening() {
                      ...
                      document.addEventListener(
                        ...
                        _this4._boundIronOverlayCanceledListener
                      );
                    };
                    ...
                    if (this._placeholder) {
                      ...
                      var finishClosing = function finishClosing() {
                        document.removeEventListener(
                          "iron-overlay-canceled",
                          _this5._boundIronOverlayCanceledListener
                        );
                ...
                },
                {
                  ...
                  value: function _stampOverlayTemplate(
                    template,
                    instanceProps
                  ) {
                    ...
                    if (_isScoped) {
                      ...
                      if (window.ShadyCSS && !window.ShadyCSS.nativeShadow) {
                        ...
                        var styleInfo = window.ShadyCSS.ScopingShim._styleInfoForNode(
                          templateRoot.host
                        );

                        if (styleInfo) {
                          scopeCssText += styleInfo._getStyleRules()
                            .parsedCssText;
                          scopeCssText += "}";
                        }
                      } // The overlay root’s :host styles should not apply inside the overlay

                      scopeCssText = scopeCssText.replace(
                        /:host/g,
                        ":host-nomatch"
                      );
                ...
                },
                {
                  ...
                  value: function _templateOrRendererChanged(
                    ...
                    var ownerOrModelChanged =
                      this._oldOwner !== owner || this._oldModel !== model;
                    this._oldModel = model;
                    this._oldOwner = owner;
                    var templateOrInstancePropsChanged =
                ...
                },
                {
                  ...
                  value: function _focusedIndex(elements) {
                    ...
                    return elements.indexOf(
                      elements.filter(this._isFocused).pop()
                    );
                  },
                },
                {
          ...
          return (
            ...
            (function(_ThemePropertyMixin) {
              ...
              function VaadinThemableMixin() {
                ...
                return _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(VaadinThemableMixin).apply(this, arguments)
                );
              }
              ...
              _createClass(VaadinThemableMixin, null, [
                {
                  ...
                  value: function finalize() {
                    ...
                    _get(
                      _getPrototypeOf(VaadinThemableMixin),
                      "finalize",
                      this
                    ).call(this);
                    ...
                    var inheritedTemplate = Object.getPrototypeOf(
                      this.prototype
                    )._template;
                    ...
                    if (inheritedTemplate && !hasOwnTemplate) {
                      ...
                      Array.from(
                        inheritedTemplate.content.querySelectorAll(
                          "style[include]"
                        )
                      ).forEach(function(s) {
                        _this._includeStyle(
                          s.getAttribute("include"),
                          template
                        );
                      });
                    }
                  ...
                  value: function _includeMatchingThemes(template) {
                    ...
                    Object.keys(modules)
                      .sort(function(moduleNameA, moduleNameB) {
                        ...
                        var vaadinThemeA =
                          vaadinThemePrefixes.filter(function(prefix) {
                      ...
                      .forEach(function(moduleName) {
                        if (moduleName !== defaultModuleName) {
                          var themeFor = modules[moduleName].getAttribute(
                            "theme-for"
                          );
                          ...
                          if (themeFor) {
                            themeFor
                              .split(" ")
                              .forEach(function(themeForToken) {
                                if (
                                  new RegExp(
                                    "^" +
                  ...
                  value: function _includeStyle(moduleName, template) {
                    if (
                      ...
                      !template.content.querySelector(
                        'style[include="'.concat(moduleName, '"]')
                      )
                    ) {
          ...
          return (
            ...
            (function(_superClass) {
              ...
              function VaadinThemePropertyMixin() {
                ...
                return _possibleConstructorReturn(
                  this,
                  _getPrototypeOf(VaadinThemePropertyMixin).apply(
                    this,
                    arguments
                  )
                );
                ...
                [
                  {
                    ...
                    value: function attributeChangedCallback(
                      ...
                      _get(
                        _getPrototypeOf(VaadinThemePropertyMixin.prototype),
                        "attributeChangedCallback",
                        this
