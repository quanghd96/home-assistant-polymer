                      ...
                      if (
                        ...
                        if (stateObj.attributes.brightness) {
                          ...
                          if (typeof brightness !== "number") {
                            var errorMessage = "Type error: state-badge expected number, but type of "
                              .concat(
                                stateObj.entity_id,
                                ".attributes.brightness is "
                              )
                              .concat(_typeof(brightness), " (")
                              .concat(brightness, ")"); // tslint:disable-next-line

                            console.warn(errorMessage);
                          } // lowest brighntess will be around 50% (that's pretty dark)

                          iconStyle.filter = "brightness(".concat(
                            (brightness + 245) / 5,
                            "%)"
                          );
                        }
