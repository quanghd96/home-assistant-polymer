...
*/
  ...
  \************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _polymer_paper_dialog_behavior_paper_dialog_shared_styles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        ...
        /* harmony import */ var _mixins_dialog_mixin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          ...
          (function(_DialogMixin) {
            ...
            function HaVoiceCommandDialog() {
              ...
              return _possibleConstructorReturn(
                this,
                _getPrototypeOf(HaVoiceCommandDialog).apply(this, arguments)
              );
            }
              ...
              [
                ...
                },
                {
                  ...
                  value: function initRecognition() {
                    ...
                    this.recognition.onerror = function() {
                      ...
                      if (text === "") {
                        text = "<JAVIS Home did not hear anything>";
                      }
                    ...
                    this.recognition.onend = function() {
                      ...
                      this.hass
                        .callApi("post", "conversation/process", {
                          text: text,
                        })
                        .then(
                          function(response) {
                    ...
                    this.recognition.onresult = function(event) {
                      ...
                      for (
                        var ind = event.resultIndex;
                        ind < event.results.length;
                        ind++
                      ) {
                ...
                },
                {
                  ...
                  value: function _scrollMessagesBottom() {
                    ...
                    setTimeout(function() {
                      _this.$.messages.scrollTop =
                        _this.$.messages.scrollHeight;
                ...
                },
                {
                  ...
                  value: function _computeMessageClasses(message) {
                    return (
                      "message " + message.who + (message.error ? " error" : "")
                    );
                  },
                },
              ],
            ...
            Object(
              _mixins_dialog_mixin__WEBPACK_IMPORTED_MODULE_5__["default"]
            )(
