/*! For license information please see chunk.81225d595836f23d8705.js.LICENSE */
  ...
  [6],
  {
    216: function(t, e, i) {
      ...
      Object(s.a)({
        ...
        get _stickyEl() {
          ...
          for (
            var t, e = Object(n.a)(this.$.slot).getDistributedNodes(), i = 0;
            (t = e[i]);
            i++
          )
        ...
        _updateScrollState: function(t, e) {
          if (0 !== this._height) {
            var i = 0,
              ...
              r = t - this._lastScrollTop,
              l = Math.abs(r),
              a = t > this._lastScrollTop,
              c = performance.now();
            if (
              (this._mayMove() &&
                (s = this._clamp(this.reveals ? n + r : t, 0, o)),
              t >= this._dHeight &&
                ((s =
                  this.condenses && !this.fixed
                    ? Math.max(this._dHeight, s)
                    : s),
              ...
              if (Math.abs(this._initScrollTop - t) > 30 || l > 10) {
                ...
                var h = r / (c - this._lastTimestamp);
                this.style.transitionDuration =
                  this._clamp((s - n) / h, 0, 300) + "ms";
              } else s = this._top;
        ...
        _ensureBgContainers: function() {
          this._bgContainer ||
            ...
            Object(n.a)(this.root).insertBefore(
              this._bgContainer,
        ...
        _getDOMRef: function(t) {
          switch (t) {
            ...
            case "mainTitle":
              return Object(n.a)(this).querySelector("[main-title]");
            case "condensedTitle":
              return Object(n.a)(this).querySelector("[condensed-title]");
          }
          return null;
        },
    ...
    242: function(t, e, i) {
      ...
      var o = {
          ...
          if (
            ...
            if ("document" === t) this.scrollTarget = this._doc;
              ...
              this.scrollTarget =
                i && i.$
                  ? i.$[t]
                  : Object(s.a)(this.ownerDocument).querySelector("#" + t);
            } else
        ...
        scroll: function(t, e) {
          var i;
          "object" === n(t) ? ((i = t.left), (e = t.top)) : (i = t),
            (i = i || 0),
            (e = e || 0),
            this.scrollTarget === this._doc
              ? window.scrollTo(i, e)
...
//# sourceMappingURL=chunk.81225d595836f23d8705.js.map
