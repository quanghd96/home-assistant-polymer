/*! For license information please see chunk.62ff618b3cde292b2392.js.LICENSE */
  ...
  [14],
  {
    198: function(n, t, e) {
      ...
      Object(o.a)({
        ...
        _updateLayoutStates: function() {
          var n = this.header;
          if (this.isAttached && n) {
            this.$.wrapper.classList.remove("initializing"),
              (n.scrollTarget = this.hasScrollingRegion
              ...
              : requestAnimationFrame(
                  function() {
                    var t = this.getBoundingClientRect(),
                      e = document.documentElement.clientWidth - t.right;
                    (n.style.left = t.left + "px"), (n.style.right = e + "px");
                  }.bind(this)
                );
            var e = this.$.contentContainer.style;
            n.fixed && !n.condenses && this.hasScrollingRegion
              ? ((e.marginTop = t + "px"), (e.paddingTop = ""))
              : ((e.paddingTop = t + "px"), (e.marginTop = ""));
          }
        },
      });
    },
    235: function(n, t, e) {
      ...
      Object(s.a)({
        ...
        get _parentNoink() {
          var n = Object(l.a)(this).parentNode;
          return !!n && !!n.noink;
        },
    ...
    236: function(n, t, e) {
      ...
      var o = e(121),
        i = {
          ...
          _onUpKey: function(n) {
            this.focusedItem.click(), n.detail.keyboardEvent.preventDefault();
          },
          _onDownKey: function(n) {
            this.focusedItem.click(), n.detail.keyboardEvent.preventDefault();
          },
          get _isRTL() {
            return "rtl" === window.getComputedStyle(this).direction;
          },
          _onLeftKey: function(n) {
            this._isRTL ? this._focusNext() : this._focusPrevious(),
              n.detail.keyboardEvent.preventDefault();
          },
          _onRightKey: function(n) {
            this._isRTL ? this._focusPrevious() : this._focusNext(),
              n.detail.keyboardEvent.preventDefault();
          },
          _onKeydown: function(n) {
            this.keyboardEventMatchesKeys(n, "up down left right esc") ||
              this._focusWithKeyboardEvent(n);
          },
        },
        a = [o.a, i];
    },
    268: function(n, t, e) {
      "use strict";
      e(4), e(44), e(107), e(106), e(55), e(85);
      var o = e(3);
      function i() {
        var n = (function(n, t) {
          t || (t = n.slice(0));
      ...
      Object(c.a)({
        ...
        _noinkChanged: function(n) {
          Object(p.a)(this)
            .querySelectorAll("paper-tab")
            .forEach(n ? this._setNoinkAttribute : this._removeNoinkAttribute);
        },
        _setNoinkAttribute: function(n) {
          n.setAttribute("noink", "");
        },
        _removeNoinkAttribute: function(n) {
          n.removeAttribute("noink");
        },
        _computeScrollButtonClass: function(n, t, e) {
          return !t || e ? "hidden" : n ? "not-visible" : "";
        },
        _computeTabsContentClass: function(n, t) {
          return n
            ? "scrollable" + (t ? " fit-container" : "")
            : " fit-container";
        },
        _computeSelectionBarClass: function(n, t) {
          return n ? "hidden" : t ? "align-bottom" : "";
        },
        ...
        _onIronSelect: function(n) {
          this._tabChanged(n.detail.item, this._previousTab),
            (this._previousTab = n.detail.item),
        ...
        _activateHandler: function() {
          this._cancelPendingActivation(),
            s.b._activateHandler.apply(this, arguments);
        },
        _scheduleActivation: function(n, t) {
          (this._pendingActivationItem = n),
        ...
        _delayedActivationHandler: function() {
          var n = this._pendingActivationItem;
          (this._pendingActivationItem = void 0),
            (this._pendingActivationTimeout = void 0),
            n.fire(this.activateEvent, null, { bubbles: !0, cancelable: !0 });
        },
        ...
        _onArrowKeyup: function(n) {
          this.autoselect &&
            this._scheduleActivation(this.focusedItem, this.autoselectDelay);
        },
        _onBlurCapture: function(n) {
          n.target === this._pendingActivationItem &&
            this._cancelPendingActivation();
        },
        ...
        _tabChanged: function(n, t) {
          ...
          var e = this.$.tabsContent.getBoundingClientRect(),
            o = e.width,
            i = n.getBoundingClientRect(),
            a = i.left - e.left;
          if (
            ((this._pos = {
              width: this._calcPercent(i.width, o),
          ...
          this._isRTL && (c = !c),
            c
              ? this._positionBar(
                  this._calcPercent(i.left + i.width - s.left, o) - 5,
                  this._left
                )
              : this._positionBar(
                  this._calcPercent(s.left + s.width - i.left, o) - 5,
                  this._calcPercent(a, o) + 5
                ),
            this.scrollable && this._scrollToSelectedIfNeeded(i.width, a);
        },
        _scrollToSelectedIfNeeded: function(n, t) {
          var e = t - this.$.tabsContainer.scrollLeft;
          e < 0
            ? (this.$.tabsContainer.scrollLeft += e)
            : (e += n - this.$.tabsContainer.offsetWidth) > 0 &&
              (this.$.tabsContainer.scrollLeft += e);
        },
        _calcPercent: function(n, t) {
          return (100 * n) / t;
        },
        _positionBar: function(n, t) {
          (n = n || 0),
            ...
            (this._left = t),
            this.transform(
              "translateX(" + t + "%) scaleX(" + n / 100 + ")",
              this.$.selectionBar
            );
        },
        _onBarTransitionEnd: function(n) {
...
//# sourceMappingURL=chunk.62ff618b3cde292b2392.js.map
