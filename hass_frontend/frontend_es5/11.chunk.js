          ...
          (function(_EventsMixin) {
            ...
            function HaComboBox() {
              ...
              return _possibleConstructorReturn(
                this,
                _getPrototypeOf(HaComboBox).apply(this, arguments)
              );
            }
        ...
        var HaServicePicker =
          ...
          (function(_LocalizeMixin) {
            ...
            function HaServicePicker() {
              ...
              return _possibleConstructorReturn(
                this,
                _getPrototypeOf(HaServicePicker).apply(this, arguments)
              );
            }
                  ...
                  value: function _hassChanged(hass, oldHass) {
                    ...
                    Object.keys(hass.services)
                      ...
                      .forEach(function(domain) {
                        var services = Object.keys(
                          hass.services[domain]
                        ).sort();

                        for (var i = 0; i < services.length; i++) {
                          result.push(
                            "".concat(domain, ".").concat(services[i])
                          );
                        }
                      });
