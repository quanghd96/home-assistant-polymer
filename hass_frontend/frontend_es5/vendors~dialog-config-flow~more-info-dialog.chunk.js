...
*/
        ...
        var IronResizableBehavior = {
           ...
           */
          stopResizeNotificationsFor: function stopResizeNotificationsFor(
            target
          ) {
          ...
          _onIronRequestResizeNotifications: function _onIronRequestResizeNotifications(
            event
          ) {
            var target =
              /** @type {!EventTarget} */
          ...
          _parentResizableChanged: function _parentResizableChanged(
            parentResizable
          ) {
            if (parentResizable) {
              window.removeEventListener("resize", this._boundNotifyResize);
...
*/
        ...
        var PaperSpinnerBehavior = {
          ...
          __computeContainerClasses: function __computeContainerClasses(
            active,
            coolingDown
          ) {
            return [
