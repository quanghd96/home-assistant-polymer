                ...
                },
                {
                  ...
                  value: function _createPanel(panel) {
                    ...
                    if (
                      ...
                      if (
                        !confirm(`Do you trust the external panel "${
                          config.name
                        }" at "${tempA.href}"?
...
(Check docs for the panel_custom component to hide this message)`)
                    ...
                    if (!config.embed_iframe) {
                      Object(
                        ...
                        () => {
                          alert(
                            `Unable to load custom panel from ${tempA.href}`
                          );
                        }
                      );
                      return;
    ...
    <iframe></iframe>
    `.trim();
                    const iframeDoc = this.querySelector("iframe").contentWindow
                      .document;
                    iframeDoc.open();
                    iframeDoc.write(
