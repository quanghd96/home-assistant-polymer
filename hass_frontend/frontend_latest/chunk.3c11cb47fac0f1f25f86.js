/*! For license information please see chunk.3c11cb47fac0f1f25f86.js.LICENSE */
...
`,
    ...
    171: function(e, t, r) {
      ...
      let c = (function(e, t, r, a) {
          ...
          var e = {
            ...
            initializeClassElements: function(e, t) {
              ...
              ["method", "field"].forEach(function(a) {
                t.forEach(function(t) {
                  var i = t.placement;
                  if (t.kind === a && ("static" === i || "prototype" === i)) {
                    var o = "static" === i ? e : r;
            ...
            decorateClass: function(e, t) {
              ...
              return a.push.apply(a, o.finishers), (o.finishers = a), o;
            },
            ...
            decorateElement: function(e, t) {
              for (
                var r = [], a = [], i = e.decorators, o = i.length - 1;
                o >= 0;
                o--
              ) {
                var n = t[e.placement];
                ...
                var s = this.fromElementDescriptor(e),
                  p = this.toElementFinisherExtras((0, i[o])(s) || s);
                (e = p.element),
                  this.addElementPlacement(e, t),
                  p.finisher && a.push(p.finisher);
                var l = p.extras;
                if (l) {
            ...
            decorateConstructor: function(e, t) {
              for (var r = [], a = t.length - 1; a >= 0; a--) {
                var i = this.fromClassDescriptor(e),
                  o = this.toClassDescriptor((0, t[a])(i) || i);
                if (
        ...
        if (a) for (var d = 0; d < a.length; d++) c = a[d](c);
        var h = t(function(e) {
            c.initializeInstanceElements(e, u.elements);
          }, r),
          u = c.decorateClass(
            (function(e) {
              for (
                ...
                var i,
                  p = e[a];
                if ("method" === p.kind && (i = t.find(r)))
                  if (s(p.descriptor) || s(i.descriptor)) {
                    if (n(p) || n(i))
                      throw new ReferenceError(
                        "Duplicated methods (" + p.key + ") can't be decorated."
                      );
                    i.descriptor = p.descriptor;
                  } else {
                    if (n(p)) {
                      if (n(i))
                        throw new ReferenceError(
        ...
        return (
          c.initializeClassElements(h.F, u.elements),
          c.runClassFinishers(h.F, u.finishers)
        );
      })(
        null,
        function(e, t) {
    ...
    `;
      ...
      customElements.define("ha-card", c);
    },
    177: function(e, t, r) {
      "use strict";
      r(4), r(44), r(41), r(52);
  ...
  <template>
    ...
    207: function(e, t, r) {
      ...
      const a = (e, t) => (e < t ? -1 : e > t ? 1 : 0),
        i = (e, t) => a(e.toLowerCase(), t.toLowerCase());
    },
    229: function(e, t, r) {
      "use strict";
      r(4), r(44), r(107), r(204), r(55), r(41);
      var a = r(53),
        i = r(34),
        o = r(67);
      const n = {
...
`;
    ...
    328: function(e, t, r) {
      ...
      const a = "system-admin",
        ...
        n = async (e, t, r) =>
          e.callWS(
            Object.assign({}, r, { type: "config/auth/update", user_id: t })
          ),
        s = async (e, t) =>
    ...
    725: function(e, t, r) {
      ...
      var a = r(0);
      r(138), r(177), r(229);
      const i = (e) => e.callWS({ type: "person/list" }),
        o = (e, t) => e.callWS(Object.assign({ type: "person/create" }, t)),
        n = (e, t, r) =>
          e.callWS(Object.assign({ type: "person/update", person_id: t }, r)),
        s = (e, t) => e.callWS({ type: "person/delete", person_id: t });
      r(171), r(147), r(153);
      var p = r(207),
        l = (r(192), r(19));
      const c = () =>
          Promise.all([r.e(0), r.e(1), r.e(3), r.e(2), r.e(103)]).then(
            r.bind(null, 721)
          ),
        d = (e, t) => {
    ...
    `
      ...
      `;
          ...
          firstUpdated(e) {
            super.firstUpdated(e), this._fetchData(), c();
          }
          async _fetchData() {
            this._usersLoad = Object(h.d)(this.hass);
            const e = await i(this.hass);
            (this._storageItems = e.storage.sort((e, t) =>
              Object(p.b)(e.name, t.name)
            )),
          ...
          _allowedUsers(e, t) {
            const r = new Set();
            for (const i of [this._configItems, this._storageItems])
              for (const e of i) e.user_id && r.add(e.user_id);
            const a = t ? t.user_id : void 0;
            return e.filter((e) => e.id === a || !r.has(e.id));
          }
          async _openDialog(e) {
            ...
            d(this, {
              ...
              createEntry: async (e) => {
                const t = await o(this.hass, e);
                this._storageItems = this._storageItems
                  .concat(t)
                  .sort((e, t) => Object(p.b)(e.name, t.name));
              },
              updateEntry: async (t) => {
                const r = await n(this.hass, e.id, t);
...
//# sourceMappingURL=chunk.3c11cb47fac0f1f25f86.js.map
