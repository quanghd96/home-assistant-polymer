      ...
      ---------------------------------------------------------------------- */
          ...
          */
          ...
          function getWidthOrHeight(elem, dimension, extra) {
            ...
            valueIsBorderBox =
              valueIsBorderBox &&
              (support.boxSizingReliable() || val === elem.style[dimension]); // Fall back to offsetWidth/offsetHeight when value is "auto"
            ...
            (RoundSlider.prototype = {
              ...
              _createHandle: function(n) {
                ...
                return (
                  ...
                  n != 1 &&
                    n != 2 &&
                    (this["_handle" + n] = this._handleDefaults()),
                  ...
                  if (hSize.charAt(0) === "+" || hSize.charAt(0) === "-")
                    ...
                    hSize.indexOf(",") &&
                      ...
                      isNumber(s[0]) &&
                        ...
                        (isSquare = !1)));
                isSquare &&
                  (h = w = isNumber(hSize) ? parseFloat(hSize) : width),
              ...
              _handleKeyDown: function(n) {
                ...
                this._isReadOnly ||
                  ...
                  t >= 35 && t <= 40) &&
                    ...
                    t == r.UP || t == r.RIGHT
                      ? (i = this._round(
                          this._limitValue(u.value + this.options.step)
                        ))
                      : t == r.DOWN || t == r.LEFT
                      ? (i = this._round(
                          this._limitValue(
                            u.value - this._getMinusStep(u.value)
                          )
                        ))
                      : t == 36
              ...
              _changeSliderValue: function(n, t) {
                ...
                if (this._rangeSlider || this._showRange) {
                  if (
                    (this._active == 1 &&
                      u <= this._oriAngle(this._handle2.angle)) ||
                    (this._active == 2 &&
                      u >= this._oriAngle(this._handle1.angle)) ||
                    this._invertRange
                  ) {
                    ...
                    r <= 180 && !(r < 0 && r > -180) && ((f = "0"), (e = "1")),
                      ...
                      (this._active == 1 ? this.block4 : this.block2).rsRotate(
                        i - 180
                      ),
                      (this._active == 1 ? this.block1 : this.block3).rsRotate(
                        i
                      );
                  }
                } else
              ...
              _checkKO: function() {
                ...
                if (typeof f == "string" && typeof ko == "object") {
                  if (
                    ((t = ko.dataFor(this._dataElement()[0])),
                    typeof t == "undefined")
                  )
                    return !0;
              ...
              _getDistance: function(n, t) {
                return Math.sqrt(
                  (n.x - t.x) * (n.x - t.x) + (n.y - t.y) * (n.y - t.y)
                );
              },
              _getXY: function(n) {
                return (
              ...
              _round: function(n) {
                ...
                return t[1]
                  ? parseFloat(n.toFixed(t[1].length))
                  : Math.round(n);
              },
              ...
              _validateEndAngle: function() {
                ...
                if (
                  ...
                  try {
                      ...
                      start + end.charAt(0) + Math.abs(parseFloat(end))
                    );
                  } catch (e) {
                    console.warn(e);
                  }
              ...
              _checkOverlay: function(n, t) {
                ...
                i.length == 0 &&
                  ((i = this.$createElement(
                    "div" + n + " rs-transition rs-bg-color"
                  )),
                ...
                if (this._getInstance() && this._isBrowserSupport) {
                  if ($.isPlainObject(n)) {
                    (n.min !== undefined || n.max !== undefined) &&
                      ...
                      n.max !== undefined &&
                        ((this.options.max = n.max), delete n.max),
                      n.value == undefined &&
