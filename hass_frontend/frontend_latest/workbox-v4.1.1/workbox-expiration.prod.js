(this.workbox = this.workbox || {}),
  (this.workbox.expiration = (function(t, e, s, i, a, h) {
    "use strict";
    try {
      self["workbox:expiration:4.1.1"] && _();
    } catch (t) {}
    const n = "workbox-expiration",
      c = "cache-entries",
      r = (t) => {
    ...
    class o {
      ...
      async expireEntries(t, e) {
        return await this.s.transaction(c, "readwrite", (s, i) => {
          ...
          a.index("timestamp").openCursor(null, "prev").onsuccess = ({
            ...
            if (a) {
              const s = a.value;
              s.cacheName === this.t &&
                ((t && s.timestamp < t) || (e && n >= e)
                  ? (a.delete(), h.push(a.value.url))
                  : n++),
                a.continue();
            } else i(h);
          };
    ...
    return (
      ...
      (t.Plugin = class {
        ...
        cachedResponseWillBeUsed({
          ...
          const h = this.k(s);
          h.expireEntries();
          const n = h.updateTimestamp(e.url);
          if (t)
            try {
              t.waitUntil(n);
            } catch (t) {}
