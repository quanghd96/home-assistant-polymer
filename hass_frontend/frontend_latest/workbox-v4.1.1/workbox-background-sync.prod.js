  ...
  (this.workbox.backgroundSync = (function(t, e, s) {
    ...
    class c {
      ...
      async h({ direction: t }) {
        ...
        if (e)
          return (
            await this.s.delete(a, e.id), delete e.id, delete e.queueName, e
          );
      }
      i(t) {
        const e = t.target.result;
        t.oldVersion > 0 && t.oldVersion < i && e.deleteObjectStore(a),
          e
    ...
    class d {
      ...
      async g({ request: t, metadata: e, timestamp: s = Date.now() }, i) {
        ...
        e && (n.metadata = e),
          ...
          this.k ? (this._ = !0) : await this.registerSync();
      }
      async R(t) {
        const e = Date.now(),
        ...
        if (s) {
          ...
          return e - s.timestamp > i
            ? this.R(t)
            : ((s.request = new o(s.requestData).toRequest()),
              delete s.requestData,
              s);
        }
      }
    ...
    return (
      ...
      (t.Plugin = class {
        ...
        async fetchDidFail({ request: t }) {
          await this.$.pushRequest({ request: t });
        }
      }),
      t
    );
