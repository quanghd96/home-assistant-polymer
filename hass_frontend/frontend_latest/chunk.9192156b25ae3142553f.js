...
`,
              ...
              : requestAnimationFrame(
                  function() {
                    var t = this.getBoundingClientRect(),
                      r = document.documentElement.clientWidth - t.right;
                    (e.style.left = t.left + "px"), (e.style.right = r + "px");
                  }.bind(this)
                );
            var r = this.$.contentContainer.style;
            e.fixed && !e.condenses && this.hasScrollingRegion
              ? ((r.marginTop = t + "px"), (r.paddingTop = ""))
              : ((r.paddingTop = t + "px"), (r.marginTop = ""));
          }
        },
      });
    },
    ...
    734: function(e, t, r) {
      "use strict";
      r.r(t);
      r(198), r(216), r(145), r(107), r(177), r(138);
      var i = r(3),
        o = r(25),
        n = (r(171), r(126), r(243), r(192), r(217)),
        a = r(0);
      function s(e) {
        var t,
          r = h(e.key);
            ...
            d: [
              ...
              },
              {
                ...
                value: function() {
                  return a.f`
      <ha-card>
        ${u.map(({ page: e, core: t, advanced: r }) =>
          (!t && !Object(n.a)(this.hass, e)) || (r && !this.showAdvanced)
            ? ""
            : a.f`
                <a href=${`/config/${e}`}>
                  <paper-item>
    ...
    `;
      ...
      customElements.define(
        "ha-config-dashboard",
        class extends Object(m.a)(Object(f.a)(o.a)) {
          static get template() {
            return i.a`
    <style include="iron-flex ha-style">
      ha-card {
