...
<dom-module id="paper-material-styles">
  <template>
    ...
    229: function(e, t, a) {
      "use strict";
      a(4), a(44), a(107), a(204), a(55), a(41);
      var i = a(53),
        r = a(34),
        n = a(67);
      const p = {
      ...
      Object(i.a)({
        ...
        __routeQueryParamsChanged: function(e) {
          if (e && this.tail) {
            ...
            for (var i in e)
              (t[i] = e[i]),
                (!a && this.queryParams && e[i] === this.queryParams[i]) ||
                  (a = !0);
        ...
        __tryToMatch: function() {
          if (this.route) {
            ...
            if ((this.autoActivate && "" === e && (e = "/"), t))
              if (e) {
                for (
                  var a = e.split("/"), i = t.split("/"), r = [], n = {}, p = 0;
                  p < i.length;
                  p++
                ) {
                  var o = i[p];
                ...
                var h = this.route.prefix + this._matched,
                  d = a.join("/");
                for (var c in (a.length > 0 && (d = "/" + d),
                (this.tail && this.tail.prefix === h && this.tail.path === d) ||
                  (s.tail = {
                    prefix: h,
                    path: d,
        ...
        __getLink: function(e) {
          var t = { tail: null };
          for (var a in this.data) t[a] = this.data[a];
    ...
    622: function(e, t, a) {
      ...
      const n = new WeakMap(),
        p = Object(r.f)((...e) => (t) => {
          let a = n.get(t);
          void 0 === a &&
            ((a = { lastRenderedIndex: 2147483647, values: [] }), n.set(t, a));
          const r = a.values;
          let p = r.length;
          a.values = e;
          for (let n = 0; n < e.length && !(n > a.lastRenderedIndex); n++) {
            const o = e[n];
            if (Object(i.h)(o) || "function" != typeof o.then) {
              t.setValue(o), (a.lastRenderedIndex = n);
              break;
            }
            (n < p && o === r[n]) ||
              ((a.lastRenderedIndex = 2147483647),
              (p = 0),
              Promise.resolve(o).then((e) => {
                const i = a.values.indexOf(o);
                i > -1 &&
                  i < a.lastRenderedIndex &&
                  ((a.lastRenderedIndex = i), t.setValue(e), t.commit());
              }));
          }
        });
    },
