/*! For license information please see chunk.11071a89bb4b9a16e5d6.js.LICENSE */
  ...
  [132],
  {
    179: function(t, e, i) {
      ...
      const o = {
          ...
          _onDialogClick: function(t) {
            for (
              var e = Object(n.a)(t).path, i = 0, s = e.indexOf(this);
              i < s;
              i++
            ) {
              var o = e[i];
    ...
    `;
          ...
          initRecognition() {
            (this.recognition = new webkitSpeechRecognition()),
              ...
              (this.recognition.onerror = function() {
                ...
                var t = this.results.final || this.results.interim;
                (this.results = null),
                  "" === t && (t = "<JAVIS Home did not hear anything>"),
              ...
              (this.recognition.onend = function() {
                if (null != this.results) {
                  var t = this.results.final || this.results.interim;
                  (this.results = null),
                    this.push("_conversation", { who: "user", text: t }),
                    this.hass
                      .callApi("post", "conversation/process", { text: t })
                      .then(
                        function(t) {
                          this.push("_conversation", {
                            who: "hass",
                            text: t.speech.plain.speech,
                          });
                        }.bind(this),
                        function() {
                          this.set(
              ...
              (this.recognition.onresult = function(t) {
                for (
                  var e = this.results, i = "", s = "", n = t.resultIndex;
                  n < t.results.length;
                  n++
                )
                  t.results[n].isFinal
                    ? (i += t.results[n][0].transcript)
                    : (s += t.results[n][0].transcript);
                this.results = { interim: s, final: e.final + i };
              }.bind(this));
          }
          startListening() {
          ...
          dialogOpenChanged(t) {
            t
              ? this.startListening()
              : !t && this.results && this.recognition.abort();
          }
          _computeMessageClasses(t) {
            return "message " + t.who + (t.error ? " error" : "");
          }
        }
      );
    },
    391: function(t, e, i) {
      ...
      e.a = Object(s.a)(
        (t) =>
          class extends Object(o.b)([a.a, n.a], t) {
            static get properties() {
...
//# sourceMappingURL=chunk.11071a89bb4b9a16e5d6.js.map
