  ...
  [88],
  {
    ...
    171: function(e, t, r) {
      ...
      let d = (function(e, t, r, i) {
            ...
            decorateElement: function(e, t) {
              for (
                ...
                var o = this.fromElementDescriptor(e),
                  c = this.toElementFinisherExtras((0, n[s])(o) || o);
                (e = c.element),
        ...
        if (i) for (var u = 0; u < i.length; u++) d = i[u](d);
        var p = t(function(e) {
            ...
            (function(e) {
              for (
                ...
                if ("method" === c.kind && (n = t.find(r)))
                  if (o(c.descriptor) || o(n.descriptor)) {
                    if (a(c) || a(n))
        ...
        listen(e, t, i) {
          super.listen(e, t, i),
            n ||
              ...
              ((n = !0), r.e(70).then(r.bind(null, 214)));
        }
      }
    ...
    328: function(e, t, r) {
      ...
      const i = "system-admin",
        n = "system-users",
        s = async (e) => e.callWS({ type: "config/auth/list" }),
        a = async (e, t, r) =>
          e.callWS(
    ...
    726: function(e, t, r) {
      ...
      var i = r(11),
        ...
        a = r(25),
        o = r(228),
        c = (r(229), r(138), r(177), r(147), r(243), r(171), r(170)),
        l = r(105),
        d = r(93);
      let u = !1;
      customElements.define(
        "ha-config-user-picker",
        class extends Object(l.a)(Object(o.a)(Object(c.a)(a.a))) {
          static get template() {
            return s.a`
      <style>
        paper-fab {
    ...
    `;
            ...
            super.connectedCallback(),
              u ||
                ...
                this.fire("register-dialog", {
                  ...
                  dialogImport: () =>
                    Promise.all([r.e(1), r.e(34)]).then(r.bind(null, 704)),
                }));
          }
          _withDefault(e, t) {
            return e || t;
          ...
          _computeUrl(e) {
            return `/config/users/${e.id}`;
          }
          _computeGroup(e, t) {
            return e(`groups.${t.group_ids[0]}`);
          }
          _computeRTL(e) {
            return Object(d.a)(e);
          }
          _addUser() {
            this.fire("show-add-user", {
              hass: this.hass,
              dialogClosedCallback: async ({ userId: e }) => {
                this.fire("reload-users"),
                  e && this.navigate(`/config/users/${e}`);
              },
            });
          }
        }
      ...
      !(function(e, t, r, i) {
            ...
            (function(e) {
              for (
                ...
                if ("method" === s.kind && (n = t.find(r)))
                  if (k(s.descriptor) || k(n.descriptor)) {
                    if (w(s) || w(n))
                      throw new ReferenceError(
        ...
        n.initializeClassElements(a.F, o.elements),
          n.runClassFinishers(a.F, o.finishers);
      })(
        [Object(p.d)("ha-user-editor")],
        function(e, t) {
          return {
            F: class extends t {
              constructor(...t) {
            ...
            <tr>
              ...
              <td>
                <select
                  ...
                  .value=${Object(f.a)(
                    this.updateComplete.then(() => t.group_ids[0])
                  )}
                >
                  ${_.map(
                    (t) => p.f`
    ...
    `
              ...
              },
              {
                ...
                value: async function(e) {
                  ...
                  const t = prompt("New name?", this.user.name);
                  if (null !== t && t !== this.user.name)
                    try {
                      await Object(v.e)(this.hass, this.user.id, { name: t }),
                        Object(m.a)(this, "reload-users");
                    } catch (r) {
                      alert(`User rename failed: ${r.message}`);
                    }
                },
              },
              {
                ...
                value: async function(e) {
                  const t = e.currentTarget,
                    r = t.value;
                  try {
                    await Object(v.e)(this.hass, this.user.id, {
                      group_ids: [r],
                    }),
                      Object(m.a)(this, "reload-users");
                  } catch (i) {
                    alert(`Group update failed: ${i.message}`),
                      (t.value = this.user.group_ids[0]);
                  }
                },
              },
              {
                ...
                value: async function(e) {
                  if (
                    ...
                    try {
                      await Object(v.c)(this.hass, this.user.id);
                    } catch (t) {
                      return void alert(t.code);
                    }
                    Object(m.a)(this, "reload-users"),
                      Object(y.a)(this, "/config/users");
                  } else e.target.blur();
                },
              },
              {
    ...
    `;
          ...
          _checkRoute(e) {
            Object(m.a)(this, "iron-resize"),
              (this._debouncer = n.a.debounce(
                this._debouncer,
                i.d.after(0),
                () => {
                  "" === e.path && this.navigate(`${e.prefix}/picker`, !0);
                }
              ));
          }
          _computeUser(e, t) {
            return e && e.filter((e) => e.id === t)[0];
          }
          _equals(e, t) {
            return e === t;
          }
          async _loadData() {
            this._users = await Object(v.d)(this.hass);
          }
        }
      );
    },
