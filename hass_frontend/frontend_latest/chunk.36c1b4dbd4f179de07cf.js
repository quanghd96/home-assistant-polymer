    ...
    108: function(t, e, i) {
      ...
      (h.prototype = {
        ...
        furthestCornerDistanceFrom: function(t, e) {
          var i = r.distance(t, e, 0, 0),
            n = r.distance(t, e, this.width, 0),
            s = r.distance(t, e, 0, this.height),
            a = r.distance(t, e, this.width, this.height);
        ...
        (c.prototype = {
          ...
          get mouseUpElapsed() {
            return this.mouseUpStart ? r.now() - this.mouseUpStart : 0;
          },
          ...
          get radius() {
            var t = this.containerMetrics.width * this.containerMetrics.width,
              ...
              i = 1.1 * Math.min(Math.sqrt(t + e), c.MAX_RADIUS) + 5,
              n = 1.1 - (i / c.MAX_RADIUS) * 0.2,
          ...
          resetInteractionState: function() {
            (this.maxRadius = 0),
              ...
              (this.containerMetrics = new h(this.element));
          },
          draw: function() {
            var t, e, i;
          ...
          downAction: function(t) {
            ...
            this.resetInteractionState(),
              (this.mouseDownStart = r.now()),
              this.center
                ? ((this.xStart = e),
                  (this.yStart = i),
                  (this.slideDistance = r.distance(
                    this.xStart,
                    this.yStart,
                    this.xEnd,
                    this.yEnd
          ...
          upAction: function(t) {
            this.isMouseDown && (this.mouseUpStart = r.now());
          },
          remove: function() {
...
`,
    ...
    67: function(t, e, i) {
      ...
      const a = {
        ...
        _downHandler: function(t) {
          n.b._downHandler.call(this, t), this.pressed && this.ensureRipple(t);
        },
