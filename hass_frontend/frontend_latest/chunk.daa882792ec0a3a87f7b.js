  ...
  [34],
  {
    119: function(e, i, n) {
      ...
      const t = {
        ...
        _copyProperties: function(e, i) {
          for (var n in i) e[n] = i[n];
        },
        _cloneConfig: function(e) {
          var i = { isClone: !0 };
          return this._copyProperties(i, e), i;
        },
        _getAnimationConfigRecursive: function(e, i, n) {
          var t;
          if (this.animationConfig)
            if (
              ...
              ((t = e ? this.animationConfig[e] : this.animationConfig),
              Array.isArray(t) || (t = [t]),
              t)
            )
              for (var a, o = 0; (a = t[o]); o++)
                if (a.animatable)
                  a.animatable._getAnimationConfigRecursive(a.type || e, i, n);
                else if (a.id) {
                  var s = i[a.id];
                  s
                    ? (s.isClone ||
                        ((i[a.id] = this._cloneConfig(s)), (s = i[a.id])),
                      this._copyProperties(s, a))
                    : (i[a.id] = a);
                } else n.push(a);
        },
        getAnimationConfig: function(e) {
          var i = {},
            n = [];
          for (var t in (this._getAnimationConfigRecursive(e, i, n), i))
            n.push(i[t]);
          return n;
        },
      };
        ...
        t,
        {
          _configureAnimations: function(e) {
              ...
              for (let o, s = 0; (o = e[s]); s++) {
                ...
                if (e.isNeonAnimation) {
                  ...
                  e.configure ||
                    ...
                    (i = e.configure(o)),
                    n.push({ result: i, config: o, neonAnimation: e });
            ...
            for (var t = 0; t < n.length; t++) {
              ...
              e && i.push({ neonAnimation: s, config: o, animation: e });
            }
            return i;
          },
          ...
          _complete: function(e) {
            for (var i = 0; i < e.length; i++)
              e[i].neonAnimation.complete(e[i].config);
            for (i = 0; i < e.length; i++) e[i].animation.cancel();
          },
          playAnimation: function(e, i) {
            ...
            if (n) {
              ...
              if (0 != t.length) {
                ...
                for (var a = 0; a < t.length; a++)
                  t[a].animation.onfinish = function() {
    ...
    179: function(e, i, n) {
      ...
      const o = {
          ...
          _onDialogClick: function(e) {
            for (
              var i = Object(a.a)(e).path, n = 0, t = i.indexOf(this);
              n < t;
              n++
            ) {
              var o = i[n];
...
`;
      s.setAttribute("strip-whitespace", ""),
        Object(t.a)({ _template: s, is: "paper-spinner", behaviors: [o.a] });
    },
    184: function(e, i, n) {
      "use strict";
    ...
    189: function(e, i, n) {
      ...
      const s = {
          getTabbableNodes: function(e) {
            var i = [];
            return this._collectTabbableNodes(e, i)
              ? o.a._sortByTabIndex(i)
              : i;
          },
          _collectTabbableNodes: function(e, i) {
            if (e.nodeType !== Node.ELEMENT_NODE || !o.a._isVisible(e))
              return !1;
            var n,
              t = e,
              s = o.a._normalizedTabIndex(t),
              r = s > 0;
            s >= 0 && i.push(t),
              (n =
                "content" === t.localName || "slot" === t.localName
                  ? Object(a.a)(t).getDistributedNodes()
                  : Object(a.a)(t.shadowRoot || t.root || t).children);
            for (var l = 0; l < n.length; l++)
              r = this._collectTabbableNodes(n[l], i) || r;
            return r;
          },
        },
        r = customElements.get("paper-dialog"),
        l = {
          get _focusableNodes() {
    ...
    `;
          ...
          ready() {
            super.ready(),
              this.addEventListener("keypress", (e) => {
                13 === e.keyCode && this._createUser(e);
              });
          }
          showDialog({ hass: e, dialogClosedCallback: i }) {
            (this.hass = e),
          ...
          async _createUser(e) {
            ...
            try {
              ...
              return (this._loading = !1), void (this._errorMsg = n.code);
            }
            try {
              ...
              return (
                (this._loading = !1),
                (this._errorMsg = n.code),
                void (await this.hass.callWS({
          ...
          _dialogDone(e) {
            this._dialogClosedCallback({ userId: e }),
              this.setProperties({
                _errorMsg: null,
                _username: "",
                _password: "",
          ...
          _openedChanged(e) {
            this._dialogClosedCallback && !e.detail.value && this._dialogDone();
          }
        }
      );
    },
