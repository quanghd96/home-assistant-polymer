...
`,
    ...
    171: function(e, t, r) {
      ...
      let c = (function(e, t, r, a) {
        var c = (function() {
          var e = {
            ...
            decorateElement: function(e, t) {
              for (
                var r = [], a = [], n = e.decorators, i = n.length - 1;
                i >= 0;
                i--
              ) {
                var o = t[e.placement];
            ...
            decorateConstructor: function(e, t) {
              for (var r = [], a = t.length - 1; a >= 0; a--) {
                var n = this.fromClassDescriptor(e),
                  i = this.toClassDescriptor((0, t[a])(n) || n);
                if (
        ...
        if (a) for (var p = 0; p < a.length; p++) c = a[p](c);
        var u = t(function(e) {
            c.initializeInstanceElements(e, h.elements);
          }, r),
          h = c.decorateClass(
            (function(e) {
              for (
        ...
        return (
          c.initializeClassElements(u.F, h.elements),
          c.runClassFinishers(u.F, h.finishers)
        );
      })(
        null,
        function(e, t) {
          ...
          ZZ: [
            ...
            function(e, t) {
              var r,
                a = (t + "").match(/([+-]|\d\d)/gi);
              a &&
                ((r = 60 * a[1] + parseInt(a[2], 10)),
                (e.timezoneOffset = "+" === a[0] ? r : -r));
            },
          ],
        };
      (y.dd = y.d),
        ...
        (a.format = function(e, t, r) {
          ...
          return (t = (t = t.replace(o, function(e, t) {
            ...
            return t in f ? f[t](e, i) : t.slice(1, t.length - 1);
          })).replace(/\?\?/g, function() {
            return s.shift();
          });
        }),
        (a.parse = function(e, t, r) {
          var i = r || a.i18n;
          if ("string" != typeof t)
          ...
          if (!c) return null;
          for (var p = 1; p < c.length; p++) l[p - 1](s, c[p], i);
          var u,
            h = new Date();
          return (
...
`,
    ...
    664: function(e, t, r) {
      "use strict";
      r.r(t);
      r(198), r(216), r(145), r(82), r(209), r(177), r(138), r(234), r(267);
      var a = r(3),
        n = r(25),
        i = (r(126), r(171), r(92), r(193)),
        o = r(170),
        s = r(105);
      let l = !1;
      customElements.define(
        "ha-panel-mailbox",
        class extends Object(s.a)(Object(o.a)(n.a)) {
          static get template() {
            return a.a`
    ...
    `;
            ...
            super.connectedCallback(),
              l ||
                ...
                this.fire("register-dialog", {
                  ...
                  dialogImport: () =>
                    Promise.all([r.e(1), r.e(35)]).then(r.bind(null, 652)),
                })),
          ...
          getMessages() {
            const e = this.platforms[this._currentPlatform];
            return this.hass
              .callApi("GET", `mailbox/messages/${e.name}`)
              .then((t) => {
                const r = [],
                  a = t.length;
                for (let n = 0; n < a; n++) {
                  const a = Object(i.a)(
                    new Date(1e3 * t[n].info.origtime),
                    this.hass.language
                  );
                  r.push({
                    timestamp: a,
                    caller: t[n].info.callerid,
                    message: t[n].text,
                    sha: t[n].sha,
                    duration: t[n].info.duration,
                    platform: e,
                  });
                }
          ...
          getPlatformName(e) {
            const t = `mailbox.${e.name}`;
            return this.hass.states[t.toLowerCase()].attributes.friendly_name;
          }
        }
      );
    },
