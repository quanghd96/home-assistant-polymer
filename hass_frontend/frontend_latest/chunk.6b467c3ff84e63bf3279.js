/*! For license information please see chunk.6b467c3ff84e63bf3279.js.LICENSE */
...
`,
    ...
    722: function(e, t, i) {
      ...
      i.r(t);
      var r = i(0);
      i(145), i(106), i(183), i(138), i(140), i(176);
      function o(e) {
        var t,
          i = c(e.key);
        "method" === e.kind
      ...
      !(function(e, t, i, r) {
        ...
        if (r) for (var d = 0; d < r.length; d++) p = r[d](p);
        var u = t(function(e) {
    ...
    `;
              ...
              },
              {
                ...
                key: "updated",
                value: function(e) {
                  p(d(i.prototype), "updated", this).call(this, e),
                    this.toggleAttribute(
                      "long",
                      (this.user ? u(this.user.name) : "?").length > 2
                    );
                },
              },
              {
    ...
    `;
      ...
      const P = ["config", "developer-tools", "hassio"],
        O = "scrollIntoViewIfNeeded" in document.body,
        j = {
          map: 1,
          logbook: 2,
          history: 3,
        ...
        z = (e, t) => {
          const i = e.component_name in j,
            r = t.component_name in j;
          return i && r
            ? j[e.component_name] - j[t.component_name]
            : i
            ? -1
            : r
            ? 1
          ...
          return {
            ...
            d: [
              ...
              },
              {
                ...
                decorators: [Object(r.g)()],
                key: "_defaultPage",
                value: () => localStorage.defaultPage || f.b,
              },
              {
                kind: "field",
                decorators: [Object(r.g)()],
              ...
              },
              {
                ...
                value: function() {
                  ...
                  const [t, i] = ((e) => {
                    ...
                    return (
                      Object.values(t).forEach((e) => {
                        e.title &&
                          (P.includes(e.component_name) ? r : i).push(e);
                      }),
                      i.sort(z),
                      r.sort(z),
                      [i, r]
                  ...
                  let o = this._notifications ? this._notifications.length : 0;
                  for (const r in e.states)
                    "configurator" === Object(y.a)(r) && o++;
                  return r.f`
      <div class="menu">
        ${
          this.narrow
            ...
            : r.f`
              <paper-icon-button
                ...
                .icon=${
                  "docked" === e.dockedSidebar ? "hass:menu-open" : "hass:menu"
                }
      ...
      <a
        class=${Object(v.a)({
          profile: !0,
          "iron-selected": "profile" === e.panelUrl,
        })}
        href="/profile"
        data-panel="panel"
        tabindex="-1"
    ...
    `;
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  return (
                    i.panels !== t.panels ||
                    i.panelUrl !== t.panelUrl ||
                    i.user !== t.user ||
                    i.localize !== t.localize ||
                    i.states !== t.states
                  );
                },
              },
              {
                ...
                key: "firstUpdated",
                value: function(e) {
                  _(T(i.prototype), "firstUpdated", this).call(this, e),
                    this.hass &&
                      this.hass.auth.external &&
                      ((e) => (
                        e.cache.cfg ||
                          (e.cache.cfg = e.sendMessage({ type: "config/get" })),
                        e.cache.cfg
                      ))(this.hass.auth.external).then((e) => {
                        this._externalConfig = e;
                      }),
              ...
              },
              {
                ...
                value: function(e) {
                  if (
                    (_(T(i.prototype), "updated", this).call(this, e),
                    e.has("alwaysExpand") &&
                  ...
                  if (!t || t.panelUrl !== this.hass.panelUrl) {
                    const e = this.shadowRoot.querySelector(".iron-selected");
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  const t = this._tooltip,
                    i = this.shadowRoot.querySelector("paper-listbox");
                  let r = e.offsetTop + 7;
                  i.contains(e) && (r -= i.scrollTop),
                    (t.innerHTML = e.querySelector(".item-text").innerHTML),
                    (t.style.display = "block"),
                    (t.style.top = `${r}px`),
                    (t.style.left = `${e.offsetLeft + e.clientWidth + 12}px`);
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                value: function() {
                  Object(h.a)(this, "hass-show-notifications");
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                key: "_toggleSidebar",
                value: function() {
                  Object(h.a)(this, "hass-toggle-menu");
                },
              },
              {
                kind: "method",
    ...
    `;
      ...
      customElements.define("ha-sidebar", D);
    },
  },
]);
//# sourceMappingURL=chunk.6b467c3ff84e63bf3279.js.map
