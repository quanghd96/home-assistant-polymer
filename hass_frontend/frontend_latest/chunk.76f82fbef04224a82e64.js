    ...
    109: function(e, r, t) {
      ...
      const a = {
        ...
        _calcStep: function(e) {
          ...
          return this.step < 1
            ? r / (1 / this.step) + this.min
            : r * this.step + this.min;
        },
          ...
          attached: function() {
            Object(s.a)(this, function() {
              if (
                ...
                var a = parseFloat(e),
                  i = (8 / 3) * a;
                "px" === r && (i = Math.floor(i)) % 2 != a % 2 && i++,
                  this.updateStyles({ "--paper-checkbox-ink-size": i + r });
              }
            });
          },
          _computeCheckboxClass: function(e, r) {
            var t = "";
            return e && (t += "checked "), r && (t += "invalid"), t;
          },
        ...
        _progressChanged: function(e, r, t, a, i) {
          ...
          this._setSecondaryRatio(n),
            ...
            i
              ...
              : this.setAttribute("aria-valuenow", r),
...
`;
      c.setAttribute("strip-whitespace", ""),
        Object(s.a)({
          ...
          _updateKnob: function(e, r, t, a, i) {
          ...
          _trackX: function(e) {
            ...
            var r = this._isRTL ? -1 : 1,
              t = Math.min(this._maxx, Math.max(this._minx, e.detail.dx * r));
            this._x = this._startx + t;
          ...
          _barclick: function(e) {
            this._w = this.$.sliderBar.offsetWidth;
            var r = this.$.sliderBar.getBoundingClientRect(),
              t = ((e.detail.x - r.left) / this._w) * 100;
            this._isRTL && (t = 100 - t);
            var a = this.ratio;
            this._setTransiting(!0),
              this._positionKnob(t),
          ...
          _updateMarkers: function(e, r, t, a) {
            a || this._setMarkers([]);
            var i = Math.round((t - r) / this.step);
            i > e && (i = e),
              (i < 0 || !isFinite(i)) && (i = 0),
