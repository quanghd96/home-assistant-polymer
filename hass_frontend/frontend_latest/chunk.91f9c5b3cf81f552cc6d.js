...
`;
    ...
    720: function(e, t, r) {
      ...
      r(229);
      var i = r(0),
        o = (r(82), r(142), r(106), r(140), r(442)),
        a = r(297);
      var n = r(19);
      let s = !1;
      const l = (e, t) => {
        s ||
          ((s = !0),
          ((e) =>
            Object(n.a)(e, "register-dialog", {
              dialogShowEvent: "show-move-card-view",
              dialogTag: "hui-dialog-move-card-view",
              dialogImport: () => r.e(44).then(r.bind(null, 707)),
            }))(e)),
          Object(n.a)(e, "show-move-card-view", t);
      };
      function c(e) {
        var t,
          r = f(e.key);
      ...
      !(function(e, t, r, i) {
        var o = (function() {
          var e = {
            ...
            decorateElement: function(e, t) {
              for (
                var r = [], i = [], o = e.decorators, a = o.length - 1;
                a >= 0;
                a--
              ) {
                var n = t[e.placement];
            ...
            decorateConstructor: function(e, t) {
              for (var r = [], i = t.length - 1; i >= 0; i--) {
                var o = this.fromClassDescriptor(e),
                  a = this.toClassDescriptor((0, t[i])(o) || o);
                if (
        ...
        if (i) for (var a = 0; a < i.length; a++) o = i[a](o);
        var n = t(function(e) {
        ...
        o.initializeClassElements(n.F, s.elements),
          o.runClassFinishers(n.F, s.finishers);
      })(
        [Object(i.d)("hui-card-options")],
        function(e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    `;
              ...
              },
              {
                ...
                value: function() {
                  const e = this.lovelace,
                    t = this.path;
                  e.saveConfig(Object(a.h)(e.config, t, [t[0], t[1] - 1]));
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                key: "_moveCard",
                value: function() {
                  l(this, { path: this.path, lovelace: this.lovelace });
                },
              },
              {
                kind: "method",
                ...
                value: function() {
                  !(async function(e, t) {
                    if (confirm("Are you sure you want to delete this card?"))
                      try {
                        await e.saveConfig(Object(a.c)(e.config, t));
                      } catch (r) {
                        alert(`Deleting failed: ${r.message}`);
                      }
