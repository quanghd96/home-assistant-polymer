          ...
          if (this.animationConfig)
            if (
              ...
              for (var a, o = 0; (a = n[o]); o++)
                if (a.animatable)
                  a.animatable._getAnimationConfigRecursive(a.type || e, t, i);
                else if (a.id) {
                  var r = t[a.id];
                  r
                    ? (r.isClone ||
          ...
          _configureAnimations: function(e) {
            ...
            if (e.length > 0)
              for (let o, r = 0; (o = e[r]); r++) {
                let e = document.createElement(o.name);
                if (e.isNeonAnimation) {
                  ...
                  e.configure ||
                    ...
                    (t = e.configure(o)),
                    i.push({ result: t, config: o, neonAnimation: e });
            ...
            for (var n = 0; n < i.length; n++) {
              ...
              try {
                ...
                (e = null), console.warn("Couldnt play", "(", o.name, ").", a);
              }
              e && t.push({ neonAnimation: r, config: o, animation: e });
            }
            return t;
          },
            ...
            if (i) {
              ...
              if (0 != n.length) {
                ...
                for (var a = 0; a < n.length; a++)
                  n[a].animation.onfinish = function() {
...
`,
        ...
        _disabledChanged: function(e) {
          a.a._disabledChanged.apply(this, arguments),
...
`;
      r.setAttribute("strip-whitespace", ""),
        Object(n.a)({ _template: r, is: "paper-spinner", behaviors: [o.a] });
    },
    185: function(e, t, i) {
      "use strict";
      function n(e) {
      ...
      (g.dd = g.d),
        ...
        (n.format = function(e, t, i) {
          ...
          return (t = (t = t.replace(r, function(e, t) {
            ...
            return t in f ? f[t](e, o) : t.slice(1, t.length - 1);
          })).replace(/\?\?/g, function() {
            return s.shift();
          });
        }),
        (n.parse = function(e, t, i) {
          ...
          var r,
            ...
            c = e.match(new RegExp(d, "i"));
          if (!c) return null;
          for (var h = 1; h < c.length; h++) l[h - 1](s, c[h], o);
          var u,
            p = new Date();
          return (
...
`,
        ...
        get header() {
          return Object(a.a)(this.$.headerSlot).getDistributedNodes()[0];
        },
...
`,
        ...
        get _stickyEl() {
          ...
          for (
            var e, t = Object(a.a)(this.$.slot).getDistributedNodes(), i = 0;
            (e = t[i]);
            i++
          )
        ...
        _updateScrollState: function(e, t) {
          if (0 !== this._height) {
            var i = 0,
              n = 0,
              a = this._top,
              o = (this._lastScrollTop, this._maxHeaderTop),
            ...
            if (
              (this._mayMove() &&
                (n = this._clamp(this.reveals ? a + r : e, 0, o)),
              e >= this._dHeight &&
                ((n =
              ...
              this.reveals &&
                !this.disabled &&
                s < 100 &&
                ((d - this._initTimestamp > 300 ||
                  this._wasScrollingDown !== l) &&
                  ((this._initScrollTop = e), (this._initTimestamp = d)),
                e >= o))
            )
              if (Math.abs(this._initScrollTop - e) > 30 || s > 10) {
                ...
                var c = r / (d - this._lastTimestamp);
                this.style.transitionDuration =
                  this._clamp((n - a) / c, 0, 300) + "ms";
              } else n = this._top;
            (i = 0 === this._dHeight ? (e > 0 ? 1 : 0) : n / this._dHeight),
              t ||
                ...
                (this._top = n),
                (this._wasScrollingDown = l),
                (this._lastTimestamp = d)),
              (t || i !== this._progress || a !== n || 0 === e) &&
                ((this._progress = i),
        ...
        _ensureBgContainers: function() {
          this._bgContainer ||
            ...
            Object(a.a)(this.root).insertBefore(
              this._bgContainer,
              this.$.contentContainer
            ));
        },
        _getDOMRef: function(e) {
          switch (e) {
            ...
            case "mainTitle":
              return Object(a.a)(this).querySelector("[main-title]");
            case "condensedTitle":
              return Object(a.a)(this).querySelector("[condensed-title]");
          }
          return null;
        },
    ...
    227: function(e, t, i) {
      ...
      const r = ["climate", "water_heater"],
        ...
        l = (e, t, i, n, a = !1) => {
          let o = "history/period";
          return (
            i && (o += "/" + i.toISOString()),
            (o += "?filter_entity_id=" + t),
            n && (o += "&end_time=" + n.toISOString()),
            a && (o += "&skip_initial_state"),
            e.callApi("GET", o)
          );
        },
        d = (e, t, i) =>
        ...
        h = (e, t, i, l) => {
          ...
          return t
            ? (t.forEach((t) => {
                ...
                const r = t.find((e) => "unit_of_measurement" in e.attributes);
                let s;
                r
                  ? (s = r.attributes.unit_of_measurement)
                  : "climate" === Object(a.a)(t[0])
                  ? (s = e.config.unit_system.temperature)
                  : "water_heater" === Object(a.a)(t[0]) &&
                    (s = e.config.unit_system.temperature),
                  s
                    ? s in d
                      ? d[s].push(t)
                    ...
                    : h.push(
                        ((e, t, i) => {
                          ...
                          for (const n of i)
                            (a.length > 0 &&
                              n.state === a[a.length - 1].state) ||
                              a.push({
                                state_localize: Object(o.a)(e, n, t),
                                state: n.state,
            ...
            var i = parseFloat(t.startsAt || 0),
              ...
              r =
                0 === i && 1 === n
                  ? e.run
                  : function(t, n) {
                      e.run.call(this, Math.max(0, (t - i) / a), n);
                    };
            return {
              setUp: e.setUp ? e.setUp.bind(this, t) : o,
              run: e.run ? r.bind(this) : o,
              tearDown: e.tearDown ? e.tearDown.bind(this) : o,
            };
          },
    ...
    259: function(e, t, i) {
      ...
      customElements.define(
        "ha-chart-base",
        class extends Object(l.b)([r.a], a.a) {
          static get template() {
            return n.a`
      <style>
        :host {
    ...
    `;
          ...
          connectedCallback() {
            super.connectedCallback(),
              ...
              null === c &&
                (c = Promise.all([i.e(12), i.e(125), i.e(67)]).then(
                  i.bind(null, 680)
                )),
              c.then((e) => {
          ...
          _customTooltips(e) {
            ...
            const n = this.$.chartTarget.clientWidth;
            let a = e.caretX;
            const o = this._chart.canvas.offsetTop + e.caretY;
            e.caretX + 100 > n ? (a = n - 100) : e.caretX < 100 && (a = 100),
              (a += this._chart.canvas.offsetLeft),
          ...
          _legendClick(e) {
            ...
            const i = e.model.itemsIndex,
              n = this._chart.getDatasetMeta(i);
            (n.hidden =
              null === n.hidden ? !this._chart.data.datasets[i].hidden : null),
              this.set(
                ["metas", i, "hidden"],
          ...
          _drawLegend() {
            ...
            (this._oldIdentifier = this.identifier),
              this.set(
                "metas",
                this._chart.data.datasets.map((i, n) => ({
                  label: i.label,
                  color: i.color,
                  bgColor: i.backgroundColor,
                  hidden:
                    t && n < this.metas.length
                      ? this.metas[n].hidden
            ...
            let i = !1;
            if (t)
              for (let n = 0; n < this.metas.length; n++) {
                const t = e.getDatasetMeta(n);
                !!t.hidden != !!this.metas[n].hidden && (i = !0),
                  (t.hidden = !!this.metas[n].hidden || null);
              }
            i && e.update(), (this.unit = this.data.unit);
          }
          _formatTickValue(e, t, i) {
            if (0 === i.length) return e;
            const n = new Date(i[t].value);
            return Object(d.a)(n);
          }
          drawChart() {
            ...
            if ((e.datasets && e.datasets.length) || this._chart) {
              if ("timeline" !== this.data.type && e.datasets.length > 0) {
                ...
                for (let n = 0; n < t; n++)
                  (e.datasets[n].borderColor = i[n].rgbString()),
                    (e.datasets[n].backgroundColor = i[n]
                      .alpha(0.6)
                      .rgbaString());
              }
              if (this._chart)
                  ...
                  "timeline" === this.data.type
                    ? (this.set("isTimeline", !0),
                      ...
                      void 0 !== this._colorFunc &&
                        (n.elements.colorFunction = this._colorFunc),
                      1 === e.datasets.length &&
                        (n.scales.yAxes[0].ticks
                          ? (n.scales.yAxes[0].ticks.display = !1)
                          : (n.scales.yAxes[0].ticks = { display: !1 }),
                        n.scales.yAxes[0].gridLines
                          ? (n.scales.yAxes[0].gridLines.display = !1)
                          : (n.scales.yAxes[0].gridLines = { display: !1 })),
                ...
                (this._chart = new this.ChartClass(t, a)),
                  !0 !== this.isTimeline &&
                    !0 === this.data.legend &&
                    this._drawLegend(),
                  this.resizeChart();
          ...
          _resizeChart() {
            ...
            const i = this._chart.chartArea.top,
              n = this._chart.chartArea.bottom,
              a = this._chart.canvas.clientHeight;
            if ((n > 0 && (this._axisHeight = a - n + i), !this._axisHeight))
              return (
                (e.style.height = "50px"),
                this._chart.resize(),
          ...
          static getColorList(e) {
            ...
            const i = 360 / e,
              n = [];
            for (let a = 0; a < e; a++)
              (n[a] = Color().hsl(i * a, 80, 38)),
                t && (n[a + e] = Color().hsl(i * a, 80, 62));
            return n;
          }
            ...
            t.forEach((t) => {
              ...
              if (
                ...
                const e =
                  ...
                  o = t.states.some(e),
                  l = t.states.some(i);
                h(s + " current temperature", !0),
                  o && h(s + " heating", !0, !0),
                  l && h(s + " cooling", !0, !0),
                  n
                    ? (h(s + " target temperature high", !0),
                      h(s + " target temperature low", !0))
                    : h(s + " target temperature", !0),
                  t.states.forEach((t) => {
                    if (!t.attributes) return;
                    const r = a(t.attributes.current_temperature),
                      s = [r];
                    if (
                      (o && s.push(e(t) ? r : null),
                      l && s.push(i(t) ? r : null),
                      ...
                      const e = a(t.attributes.target_temp_high),
                        i = a(t.attributes.target_temp_low);
                      s.push(e, i), c(new Date(t.last_changed), s);
                    } else {
                      const e = a(t.attributes.temperature);
                      s.push(e), c(new Date(t.last_changed), s);
                    }
                  });
              } else {
                h(s, "sensor" === r);
                ...
                t.states.forEach((t) => {
                  ...
                  if (null !== o && null !== n) {
                    ...
                    null !== o && null === n
                      ? (c(r, [o]), (i = r), (e = o))
                      : null === o && null === n && null !== e && (n = r);
                });
              }
              c(n, l), Array.prototype.push.apply(i, d);
            });
            const r = {
              type: "line",
              unit: e,
              ...
              options: {
                ...
                tooltips: {
                  ...
                  callbacks: {
                    title: (e, t) => {
                      const i = e[0],
                        n = t.datasets[i.datasetIndex].data[i.index].x;
                      return Object(u.a)(n, this.hass.language);
                    },
                  },
                },
                hover: { mode: "neareach" },
                  ...
                  new Date(e.last_changed) > i ||
                    (null !== s && t !== s
                      ...
                      : null === s &&
                        ((s = t),
                        (l = e.state_localize),
                        (d = new Date(e.last_changed))));
              }),
                null !== s && h.push([d, i, l, s]),
                a.push({ data: h }),
                n.push(c);
            });
            const r = {
                  ...
                  callbacks: {
                    label: (e, t) => {
                      const i = t.datasets[e.datasetIndex].data[e.index],
                        n = Object(u.a)(i[0], this.hass.language),
                        a = Object(u.a)(i[1], this.hass.language);
                      return [i[2], n, a];
                    },
                  },
                },
    ...
    260: function(e, t, i) {
      ...
      const l = {},
        ...
        c = (e, t, i, n, a, o) => {
          const r = t,
            d = l[r];
          if (d && Date.now() - d.created < 6e4 && d.language === o)
            return d.data;
          const c = Object(s.c)(e, t, i, n).then(
            (t) => Object(s.a)(e, t, a, o),
            (e) => {
              throw (delete l[t], e);
            }
          );
          return (l[r] = { created: Date.now(), language: o, data: c }), c;
        };
      const h = (e, t, i, n, a) => {
          const o = i.cacheKey,
            r = new Date(),
          ...
          let c = l,
            h = !1,
            m = d[o];
          if (m && c >= m.startTime && c <= m.endTime && m.language === a) {
            if (((c = m.endTime), (h = !0), r <= m.endTime)) return m.prom;
          } else
            m = d[o] = (function(e, t, i) {
              return {
          ...
          return (
            (m.prom = (async () => {
              let i;
              try {
                i = (await Promise.all([g, Object(s.c)(e, t, c, r, h)]))[1];
              } catch (v) {
                throw (delete d[o], v);
              }
              const b = Object(s.a)(e, i, n, a);
              return (
                h
                  ? (u(b.line, m.data.line),
                    p(b.timeline, m.data.timeline),
                    f(l, m.data))
                  : (m.data = b),
                m.data
              );
        ...
        u = (e, t) => {
          e.forEach((e) => {
            ...
            n
              ? e.data.forEach((e) => {
                  const t = n.data.find((t) => e.entity_id === t.entity_id);
                  t ? (t.states = t.states.concat(e.states)) : n.data.push(e);
                })
              : t.push(e);
          });
        },
        ...
        m = (e, t) => {
          ...
          if (0 === i) return t;
          const n = -1 === i ? t.length - 1 : i - 1;
          return (t[n].last_changed = e), t.slice(n);
        },
        f = (e, t) => {
          t.line.forEach((t) => {
            t.data.forEach((t) => {
      ...
      customElements.define(
        ...
        class extends Object(r.a)(o.a) {
          ...
          filterChangedDebouncer(...e) {
            this._debounceFilterChanged = a.a.debounce(
          ...
          filterChanged(e, t, i, n, a, o) {
            if (!this.hass) return;
            if (a && !a.cacheKey) return;
            if (!o) return;
            this._madeFirstCall = !0;
            const r = this.hass.language;
            let l;
            if ("date" === e) {
              if (!i || !n) return;
              l = Object(s.b)(this.hass, i, n).then((e) =>
                Object(s.a)(this.hass, e, o, r)
              );
            } else {
              if ("recent-entity" !== e) return;
              if (!t) return;
              l = a
                ? this.getRecentWithCacheRefresh(t, a, o, r)
                : c(this.hass, t, i, n, o, r);
            }
          ...
          getRecentWithCacheRefresh(e, t, i, n) {
            return (
              this._refreshTimeoutId &&
                (window.clearInterval(this._refreshTimeoutId),
                (this._refreshTimeoutId = null)),
    ...
    331: function(e, t, i) {
      ...
      i(213), i(194), i(290);
      var n = i(3);
      const a = n.a`<dom-module id="lumo-date-picker-overlay" theme-for="vaadin-date-picker-overlay">
  <template>
    <style include="lumo-menu-overlay">
      ...
      i(202), i(195), i(219);
      const o = n.a`<dom-module id="lumo-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        /* Sizing */
      ...
      var c = i(11),
        h = i(21),
        u = i(24);
      const p = /\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i;
      function m(e, t) {
        if ("function" != typeof e) return;
        const i = p.exec(e.toString());
        if (i)
          try {
            e = new Function(i[1]);
          } catch (n) {
      ...
      var _ = i(35);
      class w extends y(d(Object(l.a)(Object(s.a)(r.a)))) {
        static get template() {
          return n.a`
    <style>
      :host {
...
`;
      ...
      const x = n.a`<dom-module id="lumo-date-picker-overlay-content" theme-for="vaadin-date-picker-overlay-content">
  <template>
    <style>
      :host {
        position: relative;
      ...
      const D = n.a`<dom-module id="lumo-month-calendar" theme-for="vaadin-month-calendar">
  <template>
    <style>
      :host {
        -moz-user-select: none;
  ...
  <style>
    @keyframes vaadin-date-picker-month-calendar-focus-date {
      ...
      document.head.appendChild(D.content);
      i(237);
      ...
      const S = n.a`<dom-module id="lumo-text-field" theme-for="vaadin-text-field">
  <template>
    <style include="lumo-required-field lumo-field-button">
      ...
      */
      ...
      const E = {
        ...
        A = { DEFAULT: "default", ACCESSIBLE: "accessible" },
        O = (e) =>
          class extends d(e) {
            static get properties() {
              return {
              ...
              if (this.preventInvalidInput) {
                ...
                if (e.value.length > 0 && !this.checkValidity())
                  return (
                    ...
                    void (this._inputDebouncer = h.a.debounce(
            ...
            _hostPropsChanged(...e) {
              this._propagateHostAttributes(e, A.DEFAULT);
            }
            _hostAccessiblePropsChanged(...e) {
              this._propagateHostAttributes(e, A.ACCESSIBLE);
            }
            ...
            _propagateHostAttributes(e, t) {
              ...
              "accessible" === t
                ? n.forEach((t, n) => {
                    this._setOrToggleAttribute(t, e[n], i),
                      this._setOrToggleAttribute(`aria-${t}`, e[n], i);
                  })
                : n.forEach((t, n) => {
                    this._setOrToggleAttribute(t, e[n], i);
                  });
            ...
            ready() {
              ...
              var t = (O._uniqueId = 1 + O._uniqueId || 0);
      ...
      class I extends y(O(Object(l.a)(r.a))) {
        static get template() {
          return n.a`
...
`;
      ...
      const M = n.a`<dom-module id="lumo-date-picker" theme-for="vaadin-date-picker">
  <template>
    <style include="lumo-field-button">
      ...
      const P = class {
        static _getISOWeekNumber(e) {
          ...
          0 === t && (t = 7);
          var i = 4 - t,
            n = new Date(e.getTime() + 24 * i * 3600 * 1e3),
            a = new Date(0, 0);
          a.setFullYear(n.getFullYear());
          var o = n.getTime() - a.getTime(),
            r = Math.round(o / 864e5);
      ...
      class H extends Object(l.a)(Object(s.a)(r.a)) {
        static get template() {
          return n.a`
    <style>
      :host {
...
`;
        ...
        _dateEquals(e, t) {
          return P._dateEquals(e, t);
        }
        _dateAllowed(e, t, i) {
          return P._dateAllowed(e, t, i);
        }
        _isDisabled(e, t, i) {
          var n = new Date(0, 0);
          ...
          return (
            ...
            !(
              ...
              (!this._dateAllowed(n, t, i) && !this._dateAllowed(a, t, i))
          );
        }
        _getTitle(e, t) {
        ...
        _getWeekDayNames(e, t, i, n) {
          if (void 0 !== e && void 0 !== t && void 0 !== i && void 0 !== n)
            return (
              (e = this._applyFirstDayOfWeek(e, n)),
              (t = this._applyFirstDayOfWeek(t, n)),
        ...
        _getDays(e, t) {
          if (void 0 !== e && void 0 !== t) {
            ...
            for (
              ...
              this._dateAdd(i, -1);
            for (
              var n = [], a = i.getMonth(), o = e.getMonth();
              i.getMonth() === o || i.getMonth() === a;

            )
              n.push(i.getMonth() === o ? new Date(i.getTime()) : null),
                this._dateAdd(i, 1);
            return n;
          }
        }
...
`;
        ...
        ready() {
          ...
          (this._TemplateClass = Object(Y.b)(e, this, {
        ...
        _scroll() {
          if (!this._scrollDisabled) {
            ...
            var t = this.root.querySelector(".buffer").offsetTop,
              ...
              n = e < this._buffers[0].translateY + this.itemHeight + t;
            (i || n) && (this._translateBuffer(n), this._updateClones()),
              ...
              (this._debouncerScrollFinish = h.a.debounce(
        ...
        _reset() {
          (this._scrollDisabled = !0),
            ...
            (this._debouncerUpdateClones = h.a.debounce(
          ...
          this._buffers.forEach((t) => {
            for (var i = 0; i < this.bufferSize; i++) {
              ...
              const n =
                  ...
                  (N._contentIndex = N._contentIndex + 1 || 0),
        ...
        _updateClones(e) {
          ...
          this._buffers.forEach((i, n) => {
            if (!i.updated) {
              var a = this._firstIndex + this.bufferSize * n;
              [].forEach.call(i.children, (i, n) => {
                const o = i._itemWrapper;
                (e && !this._isVisible(o, t)) || (o.instance.index = a + n);
              }),
                (i.updated = !0);
            }
          }, this);
      ...
      class W extends Object(l.a)(Object(z.a)(Object(s.a)(r.a))) {
        static get template() {
          return n.a`
    <style>
      :host {
...
`;
        ...
        connectedCallback() {
          super.connectedCallback(),
            ...
            B.a.requestAvailability();
        }
        announceFocusedDate() {
          var e = this._currentlyFocusedDate(),
            t = [];
          P._dateEquals(e, new Date()) && t.push(this.i18n.today),
            (t = t.concat([
              this.i18n.weekdays[e.getDay()],
              e.getDate(),
              this.i18n.monthNames[e.getMonth()],
            ...
            this.showWeekNumbers &&
              ...
              (t.push(this.i18n.week), t.push(P._getISOWeekNumber(e))),
            this.dispatchEvent(
        ...
        revealDate(e) {
          if (e) {
            var t = this._differenceInMonths(e, this._originDate),
              ...
              a = this.$.monthScroller.position + n - 1 < t;
            i
              ? this._scrollToPosition(t, !0)
              : a && this._scrollToPosition(t - n + 1, !0);
          }
        }
        _onOverlayFocus() {
          this._focused = !0;
        ...
        _formatDisplayed(e, t, i) {
          return e ? t(P._extractDateParts(e)) : i;
        }
        _onTodayTap() {
          var e = new Date();
          Math.abs(
        ...
        _eventKey(e) {
          for (
            ...
            var n = t[i];
            if (j.a.keyboardEventMatchesKeys(e, n)) return n;
          }
        }
        _onKeydown(e) {
          var t = this._currentlyFocusedDate();
          const i = e.composedPath().indexOf(this.$.todayButton) >= 0,
            n = e.composedPath().indexOf(this.$.cancelButton) >= 0,
            a = !i && !n;
          var o = this._eventKey(e);
          if ("tab" === o) {
            e.stopPropagation();
            ...
            switch ((e.preventDefault(), e.stopPropagation(), o)) {
              case "down":
              ...
              case "up":
                ...
                break;
              case "right":
                a && this._moveFocusByDays(1);
                break;
              case "left":
                a && this._moveFocusByDays(-1);
                break;
              case "enter":
                a || n ? this._close() : i && this._onTodayTap();
                break;
              case "space":
                if (n) this._close();
                else if (i) this._onTodayTap();
                else {
                  var r = this.focusedDate;
                  P._dateEquals(r, this.selectedDate)
                    ? ((this.selectedDate = ""), (this.focusedDate = r))
                    : (this.selectedDate = r);
                }
                break;
              case "home":
        ...
        _focusClosestDate(e) {
          this._focusDate(P._getClosestDate(e, [this.minDate, this.maxDate]));
        }
        _moveFocusByDays(e) {
          var t = this._currentlyFocusedDate(),
            i = new Date(0, 0);
        ...
        _isTodayAllowed(e, t) {
          var i = new Date(),
            n = new Date(0, 0);
          return (
            n.setFullYear(i.getFullYear()),
            n.setMonth(i.getMonth()),
            n.setDate(i.getDate()),
            this._dateAllowed(n, e, t)
          );
        }
        _stopPropagation(e) {
          e.stopPropagation();
      ...
      var q = i(95),
        K = i(70);
      const U = (e) =>
        class extends Object(K.b)([q.a], e) {
          static get properties() {
            return {
                    ...
                    if (
                      (3 === t.length
                        ? ((o = parseInt(t[2])),
                          ...
                          (n = parseInt(t[1])))
                        : 2 === t.length
                        ? ((a = parseInt(t[0]) - 1), (n = parseInt(t[1])))
                        : 1 === t.length && (n = parseInt(t[0])),
                      void 0 !== n)
                    )
                      return { day: n, month: a, year: o };
                  },
                  formatTitle: (e, t) => e + " " + t,
                }),
              },
          ...
          _formatISO(e) {
            ...
            return (
              a < 0
                ? ((a = -a), (i = "-"), (n = "000000"))
                : e.getFullYear() >= 1e4 && ((i = "+"), (n = "000000")),
              [i + t(a, n), t(e.getMonth() + 1), t(e.getDate())].join("-")
            );
          }
          _openedChanged(e) {
          ...
          _selectedDateChanged(e, t) {
            ...
            const i = e && t(P._extractDateParts(e)),
              n = this._formatISO(e);
            n !== this.value && (this.validate(i), (this.value = n)),
          ...
          _focusedDateChanged(e, t) {
            void 0 !== e &&
              ...
              this._ignoreFocusedDateChange ||
                this._noInput ||
                (this._inputValue = e ? t(P._extractDateParts(e)) : ""));
          }
          _updateHasValue(e) {
            e
          ...
          _handleDateChange(e, t, i) {
            if (t) {
              var n = this._parseDate(t);
              n ? P._dateEquals(this[e], n) || (this[e] = n) : (this.value = i);
            } else this[e] = "";
          }
          _valueChanged(e, t) {
          ...
          _onOverlayOpened() {
            ...
            var e = this._parseDate(this.initialPosition),
              t =
                ...
                e ||
                new Date();
            e || P._dateAllowed(t, this._minDate, this._maxDate)
              ? (this._overlayContent.initialPosition = t)
              : (this._overlayContent.initialPosition = P._getClosestDate(t, [
                  this._minDate,
                  this._maxDate,
                ])),
                ...
                (this._selectedDate &&
                  e ===
                    this.i18n.formatDate(
                      P._extractDateParts(this._selectedDate)
                    )),
              i =
                !this._selectedDate ||
                P._dateAllowed(
            ...
            return (
              this._inputElement &&
                (this._inputElement.checkValidity
                  ? (n = this._inputElement.checkValidity(e))
                  : this._inputElement.validate &&
                    (n = this._inputElement.validate(e))),
              t && i && n
            );
          }
          _onScroll(e) {
          ...
          _validateInput(e, t, i) {
            e && (t || i) && (this.invalid = !P._dateAllowed(e, t, i));
          }
          _onUserInput(e) {
          ...
          _userInputValueChanged(e) {
            if (this.opened && this._inputValue) {
              ...
              this._isValidDate(t) &&
                ((this._ignoreFocusedDateChange = !0),
                P._dateEquals(t, this._focusedDate) || (this._focusedDate = t),
                (this._ignoreFocusedDateChange = !1));
            }
          }
      ...
      class X extends y(d(Object(l.a)(Object(z.a)(U(Object(s.a)(r.a)))))) {
        static get template() {
          return n.a`
    <style>
      :host {
...
`;
    ...
    661: function(e, t, i) {
      "use strict";
      i.r(t);
      i(198), i(216), i(145), i(141), i(106), i(90), i(138), i(140);
      var n = i(3),
        a = i(25),
        o = (i(331), i(126), i(259), i(260), i(390), i(92), i(231)),
        r = i(170),
        s = i(93);
      customElements.define(
        "ha-panel-history",
    ...
    `;
          ...
          connectedCallback() {
            super.connectedCallback(),
              ...
              this.$.picker.set("i18n.formatDate", (e) =>
                Object(o.a)(
          ...
          _computeStartTime(e) {
            if (e) {
              var t = e.split("-");
              return (t[1] = parseInt(t[1]) - 1), new Date(t[0], t[1], t[2]);
            }
          }
          _computeEndTime(e, t) {
            var i = this._computeStartTime(e),
              n = new Date(i);
            return n.setDate(i.getDate() + this._computeFilterDays(t)), n;
          }
          _computeFilterDays(e) {
            switch (e) {
              case 1:
                return 3;
              case 2:
