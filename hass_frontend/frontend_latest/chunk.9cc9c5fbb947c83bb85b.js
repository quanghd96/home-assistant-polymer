...
`,
    ...
    `;
          ...
          _done() {
            const e = this.shadowRoot.querySelector("paper-card");
            (e.style.transition = "bottom .25s"),
              (e.style.bottom = `-${e.offsetHeight + 8}px`),
