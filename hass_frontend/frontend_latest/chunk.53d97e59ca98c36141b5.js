/*! For license information please see chunk.53d97e59ca98c36141b5.js.LICENSE */
    ...
    123: function(t, e, i) {
      ...
      const r = {
        ...
        isFocusable: function(t) {
          return s.call(t, "input, select, textarea, button, object")
            ? s.call(t, ":not([disabled])")
            : s.call(
                t,
        ...
        _collectTabbableNodes: function(t, e) {
          ...
          var i,
            n = t,
            s = this._normalizedTabIndex(n),
            r = s > 0;
          s >= 0 && e.push(n),
            (i =
              "content" === n.localName || "slot" === n.localName
                ? Object(o.a)(n).getDistributedNodes()
                : Object(o.a)(n.root || n).children);
          for (var l = 0; l < i.length; l++)
            r = this._collectTabbableNodes(i[l], e) || r;
          return r;
        },
        ...
        _sortByTabIndex: function(t) {
          ...
          if (e < 2) return t;
          var i = Math.ceil(e / 2),
            o = this._sortByTabIndex(t.slice(0, i)),
            n = this._sortByTabIndex(t.slice(i));
          return this._mergeSortByTabIndex(o, n);
        },
        _mergeSortByTabIndex: function(t, e) {
          for (var i = []; t.length > 0 && e.length > 0; )
        ...
        _hasLowerTabOrder: function(t, e) {
          var i = Math.max(t.tabIndex, 0),
            o = Math.max(e.tabIndex, 0);
    ...
    84: function(t, e, i) {
      ...
      const n = {
        ...
        get _defaultPositionTarget() {
          var t = Object(o.a)(this).parentNode;
          return (
        ...
        position: function() {
          if (this.__shouldPosition) {
            ...
            var t = this.getBoundingClientRect(),
              ...
              o = this._fitInfo.margin,
              n = {
                width: t.width + o.left + o.right,
                height: t.height + o.top + o.bottom,
              },
              s = this.__getPosition(
              ...
              r = s.left + o.left,
              l = s.top + o.top,
              a = Math.min(i.right - o.right, r + t.width),
              h = Math.min(i.bottom - o.bottom, l + t.height);
            (r = Math.max(
              i.left + o.left,
              Math.min(r, a - this._fitInfo.sizedBy.minWidth)
            )),
              (l = Math.max(
                i.top + o.top,
                Math.min(l, h - this._fitInfo.sizedBy.minHeight)
              )),
              (this.sizingTarget.style.maxWidth =
                Math.max(a - r, this._fitInfo.sizedBy.minWidth) + "px"),
              (this.sizingTarget.style.maxHeight =
                Math.max(h - l, this._fitInfo.sizedBy.minHeight) + "px"),
              (this.style.left = r - t.left + "px"),
              (this.style.top = l - t.top + "px");
          }
        },
        constrain: function() {
          if (!this.__shouldPosition) {
        ...
        _sizeDimension: function(t, e, i, o, n) {
          this.__sizeDimension(t, e, i, o, n);
        },
        __sizeDimension: function(t, e, i, o, n) {
          var s = this._fitInfo,
            r = this.__getNormalizedRect(this.fitInto),
            l = "Width" === n ? r.width : r.height,
            a = e === o,
            h = a ? l - t[o] : t[i],
            c = s.margin[a ? i : o],
            d = "offset" + n,
            f = this[d] - this.sizingTarget[d];
          this.sizingTarget.style["max" + n] = l - c - h - f + "px";
        },
        center: function() {
          if (!this.__shouldPosition) {
            this._discoverInfo();
            ...
            if (!t.vertically || !t.horizontally) {
              ...
              var e = this.getBoundingClientRect(),
                i = this.__getNormalizedRect(this.fitInto);
              if (!t.vertically) {
                var o = i.top - e.top + (i.height - e.height) / 2;
                this.style.top = o + "px";
              }
              if (!t.horizontally) {
                var n = i.left - e.left + (i.width - e.width) / 2;
        ...
        __getOffscreenArea: function(t, e, i) {
          var o =
              Math.min(0, t.top) + Math.min(0, i.bottom - (t.top + e.height)),
            n = Math.min(0, t.left) + Math.min(0, i.right - (t.left + e.width));
          return Math.abs(o) * e.width + Math.abs(n) * e.height;
        },
        __getPosition: function(t, e, i, o, n, s) {
          var r,
            l = [
              {
                verticalAlign: "top",
          ...
          if (this.noOverlap) {
            for (var a = 0, h = l.length; a < h; a++) {
              var c = {};
              for (var d in l[a]) c[d] = l[a][d];
              l.push(c);
            }
            (l[0].top = l[1].top += n.height),
              (l[2].top = l[3].top -= n.height),
              (l[4].left = l[6].left += n.width),
              (l[5].left = l[7].left -= n.width);
          }
          (e = "auto" === e ? null : e),
            ((t = "auto" === t ? null : t) && "center" !== t) ||
              (l.push({
                ...
                top:
                  n.top + this.verticalOffset + (this.noOverlap ? n.height : 0),
                left:
                  n.left - o.width / 2 + n.width / 2 + this.horizontalOffset,
              }),
              l.push({
                verticalAlign: "bottom",
                horizontalAlign: "center",
          ...
          for (a = 0; a < l.length; a++) {
            var f = l[a],
              u = f.verticalAlign === e,
              _ = f.horizontalAlign === t;
            if (!this.dynamicAlign && !this.noOverlap && u && _) {
              r = f;
              break;
            }
            var p = (!e || u) && (!t || _);
            if (this.dynamicAlign || p) {
              if (
                ((f.offscreenArea = this.__getOffscreenArea(f, i, s)),
                0 === f.offscreenArea && p)
              ) {
                r = f;
                break;
              ...
              r = r || f;
              var g = f.offscreenArea - r.offscreenArea;
              (g < 0 || (0 === g && (u || _))) && (r = f);
            }
          }
          return r;
...
`,
        ...
        prepare: function() {
          this.opened &&
            !this.parentNode &&
            Object(o.a)(document.body).appendChild(this);
        },
        open: function() {
          this.opened = !0;
        },
        ...
        complete: function() {
          this.opened ||
            ...
            Object(o.a)(this.parentNode).removeChild(this);
        },
      ...
      const f = function() {
        (this._overlays = []),
          ...
          d.a(document.documentElement, "tap", function() {}),
      ...
      f.prototype = {
        ...
        get deepActiveElement() {
          ...
          for (
            ...
            t.root && Object(o.a)(t.root).activeElement;

          )
            t = Object(o.a)(t.root).activeElement;
          return t;
        },
        _bringOverlayAtIndexToFront: function(t) {
          ...
          if (e) {
            var i = this._overlays.length - 1,
              o = this._overlays[i];
            if ((o && this._shouldBeBehindOverlay(e, o) && i--, !(t >= i))) {
              var n = Math.max(this.currentOverlayZ(), this._minimumZ);
              for (this._getZ(e) <= n && this._applyOverlayZ(e, n); t < i; )
        ...
        addOverlay: function(t) {
          ...
          var i = this._overlays.length,
            o = this._overlays[i - 1],
            n = Math.max(this._getZ(o), this._minimumZ),
            s = this._getZ(t);
          if (o && this._shouldBeBehindOverlay(t, o)) {
            this._applyOverlayZ(o, n), i--;
            var r = this._overlays[i - 1];
            n = Math.max(this._getZ(r), this._minimumZ);
          }
          s <= n && this._applyOverlayZ(t, n),
            this._overlays.splice(i, 0, t),
            this.trackBackdrop();
        },
        ...
        _getZ: function(t) {
          ...
          if (t) {
            var i = Number(t.style.zIndex || window.getComputedStyle(t).zIndex);
            i == i && (e = i);
          }
          return e;
        },
        ...
        _onCaptureClick: function(t) {
          ...
          if (-1 !== e)
            for (
              var i, n = Object(o.a)(t).path;
              (i = this._overlays[e]) &&
              this._overlayInPath(n) !== i &&
              (i._onCaptureClick(t), i.allowClickThrough);
        ...
        _onCaptureKeyDown: function(t) {
          var e = this.currentOverlay();
          e &&
            (c.a.keyboardEventMatchesKeys(t, "esc")
              ? e._onCaptureEsc(t)
              : c.a.keyboardEventMatchesKeys(t, "tab") && e._onCaptureTab(t));
        },
            ...
            (function() {
              _ =
                ...
                function(t) {
                  t.cancelable &&
                    (function(t) {
                      var e = Object(o.a)(t).rootTarget;
                      "touchmove" !== t.type &&
                        v !== e &&
                        ((v = e),
                        (y = (function(t) {
                          for (var e = [], i = t.indexOf(p), o = 0; o <= i; o++)
                            if (t[o].nodeType === Node.ELEMENT_NODE) {
                              var n = t[o],
                                s = n.style;
                              "scroll" !== s.overflow &&
                                "auto" !== s.overflow &&
                      ...
                      var i = (function(t) {
                        ...
                        if ("deltaX" in t);
                          ...
                          (e.deltaX = g.pageX - i.pageX),
                            (e.deltaY = g.pageY - i.pageY);
                        }
                        return e;
                      })(t);
                      return !(function(t, e, i) {
                        if (!e && !i) return;
                        for (
                          var o = Math.abs(i) >= Math.abs(e), n = 0;
                          n < t.length;
                          n++
                        ) {
                          var s = t[n];
                  ...
                  if (t.targetTouches) {
                    ...
                    (g.pageX = e.pageX), (g.pageY = e.pageY);
                  }
                }.bind(void 0);
              for (var t = 0, e = m.length; t < e; t++)
                document.addEventListener(m[t], _, {
                  capture: !0,
                  passive: !1,
                });
            })(),
      ...
      function O(t) {
        ...
        -1 !== e &&
          ...
          0 === w.length &&
            (function() {
              for (var t = 0, e = m.length; t < e; t++)
                document.removeEventListener(m[t], _, {
                  capture: !0,
                  passive: !1,
                });
            })());
      ...
      const C = {
          ...
          get _focusNode() {
            return (
              this._focusedChild ||
              Object(o.a)(this).querySelector("[autofocus]") ||
              this
            );
          },
          get _focusableNodes() {
          ...
          detached: function() {
            for (var t in (Object(o.a)(this).unobserveNodes(this._observer),
            (this._observer = null),
            this.__rafs))
          ...
          cancel: function(t) {
            this.fire("iron-overlay-canceled", t, { cancelable: !0 })
          ...
          _applyFocus: function() {
            if (this.opened) this.noAutoFocus || this._focusNode.focus();
              ...
              if (this.restoreFocusOnClose && this.__restoreFocusNode) {
                ...
                (t === document.body || Object(o.a)(this).deepContains(t)) &&
          ...
          _onCaptureTab: function(t) {
            if (this.withBackdrop) {
              ...
              var e = t.shiftKey,
                i = e ? this.__firstFocusableNode : this.__lastFocusableNode,
                o = e ? this.__lastFocusableNode : this.__firstFocusableNode,
                n = !1;
              if (i === o) n = !0;
              else {
          ...
          __deraf: function(t, e) {
            var i = this.__rafs;
            null !== i[t] && cancelAnimationFrame(i[t]),
              (i[t] = requestAnimationFrame(
                function() {
                  (i[t] = null), e.call(this);
                }.bind(this)
              ));
          },
          __updateScrollObservers: function(t, e, i) {
            t && e && this.__isValidScrollAction(i)
              ? ("lock" === i && (this.__saveScrollPosition(), b(this)),
                this.__addScrollListeners())
              : (O(this), this.__removeScrollListeners());
          },
          __addScrollListeners: function() {
            if (!this.__rootNodes) {
              if (((this.__rootNodes = []), r.g))
                for (var t = this; t; )
          ...
          __onCaptureScroll: function(t) {
            if (!(this.__isAnimating || Object(o.a)(t).path.indexOf(this) >= 0))
...
//# sourceMappingURL=chunk.53d97e59ca98c36141b5.js.map
