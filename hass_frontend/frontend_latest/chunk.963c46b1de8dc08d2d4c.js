/*! For license information please see chunk.963c46b1de8dc08d2d4c.js.LICENSE */
...
`,
    ...
    188: function(e, t, r) {
      ...
      const o = {
        ...
        cover: function(e) {
          ...
          switch (e.attributes.device_class) {
            ...
            default:
              return Object(s.a)("cover", e.state);
          }
        },
        sensor: function(e) {
      ...
      function c(e) {
        ...
        return t in o ? o[t](e) : Object(s.a)(t, e.state);
      }
    },
    192: function(e, t, r) {
      "use strict";
    ...
    207: function(e, t, r) {
      ...
      const i = (e, t) => (e < t ? -1 : e > t ? 1 : 0),
        n = (e, t) => i(e.toLowerCase(), t.toLowerCase());
    },
    288: function(e, t, r) {
      "use strict";
      r.d(t, "a", function() {
      ...
      const a = (e, t) => {
        ...
        d = (e, t) =>
          e.subscribeEvents(
            Object(s.a)(() => l(e).then((e) => t.setState(e, !0)), 500, !0),
            "entity_registry_updated"
          ),
        p = (e, t) => Object(i.d)("_entityRegistry", l, d, e, t);
    },
    735: function(e, t, r) {
      "use strict";
      r.r(t);
      var i = r(0),
        n = (r(183), r(177), r(288)),
        s = (r(147), r(153), r(171), r(176), r(175)),
        a = r(188),
        o = r(118),
        c = (r(192), r(19));
      const l = () =>
        Promise.all([r.e(0), r.e(1), r.e(107), r.e(32)]).then(
          r.bind(null, 702)
        );
      var d = r(207);
      function p(e) {
            ...
            (function(e) {
              for (
                ...
                if ("method" === s.kind && (n = t.find(r)))
                  if (f(s.descriptor) || f(n.descriptor)) {
                    if (h(s) || h(n))
                      throw new ReferenceError(
              ...
              return i.f`
                <paper-icon-item @click=${this._openEditEntry} .entry=${e}>
                  <ha-icon
                    slot="item-icon"
                    .icon=${
                      t ? Object(a.a)(t) : Object(s.a)(Object(o.a)(e.entity_id))
                    }
                  ></ha-icon>
                  <paper-item-body two-line>
                    <div class="name">
                      ${Object(n.a)(this.hass, e) ||
                        this.hass.localize(
    ...
    `
      ...
      `;
              ...
              },
              {
                ...
                key: "firstUpdated",
                value: function(e) {
                  v(b(r.prototype), "firstUpdated", this).call(this, e), l();
                },
              },
              {
                kind: "method",
                key: "updated",
                value: function(e) {
                  v(b(r.prototype), "updated", this).call(this, e),
                    this._unsubEntities ||
                      (this._unsubEntities = Object(n.c)(
                        this.hass.connection,
                        (e) => {
                          this._entities = e.sort((e, t) =>
                            Object(d.b)(e.entity_id, t.entity_id)
                          );
                        }
                      ));
                },
                ...
                value: function(e) {
                  ...
                  (r = this),
                    (i = {
                      entry: t,
                      updateEntry: async (e) => {
                        const r = await Object(n.d)(this.hass, t.entity_id, e);
                        this._entities = this._entities.map((e) =>
                          e === t ? r : e
                        );
                      },
                      removeEntry: async () => {
                        ...
                        try {
                          return (
                            await Object(n.b)(this.hass, t.entity_id),
    ...
    `;
      ...
      customElements.define("ha-config-entity-registry", g);
    },
  },
]);
//# sourceMappingURL=chunk.963c46b1de8dc08d2d4c.js.map
