...
`,
        ...
        _onKeypress: function(t) {
          if (this.allowedPattern || "number" === this.inputElement.type) {
            ...
            if (e && !(t.metaKey || t.ctrlKey || t.altKey)) {
              ...
              var i = String.fromCharCode(t.charCode);
              this._isPrintable(t) &&
                !e.test(i) &&
                (t.preventDefault(),
                this._announceInvalidCharacter(
    ...
    119: function(t, e, i) {
      ...
      const n = {
        ...
        _getAnimationConfigRecursive: function(t, e, i) {
          var n;
          if (this.animationConfig)
            if (
              ...
              for (var a, o = 0; (a = n[o]); o++)
                if (a.animatable)
                  a.animatable._getAnimationConfigRecursive(a.type || t, e, i);
                else if (a.id) {
                  var l = e[a.id];
                  l
                    ? (l.isClone ||
                        ((e[a.id] = this._cloneConfig(l)), (l = e[a.id])),
                      this._copyProperties(l, a))
                    : (e[a.id] = a);
                } else i.push(a);
        },
        getAnimationConfig: function(t) {
          var e = {},
            i = [];
          for (var n in (this._getAnimationConfigRecursive(t, e, i), e))
            i.push(e[n]);
          return i;
        },
      };
        ...
        n,
        {
          _configureAnimations: function(t) {
            var e = [],
              i = [];
            if (t.length > 0)
              for (let o, l = 0; (o = t[l]); l++) {
                let t = document.createElement(o.name);
                if (t.isNeonAnimation) {
                  ...
                  t.configure ||
                    ...
                    (e = t.configure(o)),
                    i.push({ result: e, config: o, neonAnimation: t });
            ...
            for (var n = 0; n < i.length; n++) {
              ...
              try {
                ...
                (t = null), console.warn("Couldnt play", "(", o.name, ").", a);
              }
              t && e.push({ neonAnimation: l, config: o, animation: t });
            }
            return e;
          },
          _shouldComplete: function(t) {
            for (var e = !0, i = 0; i < t.length; i++)
              if ("finished" != t[i].animation.playState) {
                e = !1;
                break;
              }
            return e;
          ...
          playAnimation: function(t, e) {
            var i = this.getAnimationConfig(t);
            if (i) {
          ...
          cancelAnimation: function() {
            for (var t in this._active) {
              ...
              for (var i in e) e[i].animation.cancel();
            }
            this._active = {};
          },
        },
    ...
    179: function(t, e, i) {
      ...
      const o = {
          ...
          _onDialogClick: function(t) {
            for (
              var e = Object(a.a)(t).path, i = 0, n = e.indexOf(this);
              i < n;
              i++
            ) {
              var o = e[i];
