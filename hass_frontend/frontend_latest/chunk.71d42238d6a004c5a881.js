  ...
  [140],
  {
    ...
    171: function(e, t, i) {
      ...
      let d = (function(e, t, i, r) {
        ...
        return (
          d.initializeClassElements(f.F, h.elements),
          d.runClassFinishers(f.F, h.finishers)
        );
      })(
        null,
        function(e, t) {
    ...
    230: function(e, t, i) {
      ...
      customElements.define(
        ...
        class extends Object(a.a)(n.a) {
          ...
          updateRelative() {
            const e = Object(r.a)(this);
            this.parsedDateTime
              ? (e.innerHTML = Object(o.a)(this.parsedDateTime, this.localize))
    ...
    242: function(e, t, i) {
      ...
      function o(e, t, i = {}) {
        let o = ((i.compareTime || new Date()).getTime() - e.getTime()) / 1e3;
        const a = o >= 0 ? "past" : "future";
        let s;
        o = Math.abs(o);
        ...
        return (
          ...
          !1 === i.includeTense
            ? s
            : t(`ui.components.relative_time.${a}`, "time", s)
        );
      }
    },
    258: function(e, t, i) {
...
`,
    ...
    717: function(e, t, i) {
      ...
      !(function(e, t, i, r) {
        ...
        n.initializeClassElements(f.F, h.elements),
          n.runClassFinishers(f.F, h.finishers);
      })(
        [Object(o.d)("notification-item-template")],
        function(e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    `;
      ...
      !(function(e, t, i, r) {
        ...
        [Object(o.d)("configurator-notification-item")],
        function(e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    `
              ...
              },
              {
                ...
                key: "_handleClick",
                value: function() {
                  Object(f.a)(this, "hass-more-info", {
      ...
      !(function(e, t, i, r) {
        ...
        [Object(o.d)("persistent-notification-item")],
        function(e, t) {
          return {
            F: class extends t {
              constructor(...t) {
    ...
    `;
              ...
              },
              {
                ...
                value: function(e, t) {
                  if (!e || !t) return;
                  return new Date(t.created_at).toLocaleDateString(e.language, {
                    year: "numeric",
                    month: "short",
                    day: "numeric",
                    minute: "numeric",
      ...
      const S = customElements.get("paper-icon-button");
      customElements.define(
      ...
      var z = i(105),
        ...
        F = i(132),
        $ = i(118);
      i.d(t, "HuiNotificationDrawer", function() {
        return L;
      });
      class L extends Object(z.a)(Object(j.a)(n.a)) {
        static get template() {
          return r.a`
    ...
    `;
        ...
        static get properties() {
          return {
            hass: Object,
            open: { type: Boolean, observer: "_openChanged" },
            notifications: {
              type: Array,
              computed:
                "_computeNotifications(open, hass, _notificationsBackend)",
            },
            _notificationsBackend: { type: Array, value: [] },
          };
        }
        ready() {
          super.ready(),
        ...
        _openChanged(e) {
          e
            ? (this._unsubNotifications = Object(F.a)(
                this.hass.connection,
                (e) => {
                  this._notificationsBackend = e;
                }
              ))
            : this._unsubNotifications &&
              (this._unsubNotifications(), (this._unsubNotifications = void 0));
        }
        _computeNotifications(e, t, i) {
          if (!e) return [];
          const r = Object.keys(t.states)
            .filter((e) => "configurator" === Object($.a)(e))
            .map((e) => t.states[e]);
          return i.concat(r);
        }
        showDialog({ narrow: e }) {
          this.style.setProperty(
            "--app-drawer-width",
            e ? window.innerWidth + "px" : "500px"
          ),
            this.$.drawer.open();
        }
      }
      customElements.define("notification-drawer", L);
    },
  },
]);
