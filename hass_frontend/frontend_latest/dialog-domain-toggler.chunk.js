...
*/
  ...
  \*************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        let DomainTogglerDialog = _decorate(
          [
                ...
                },
                {
                  ...
                  value: function render() {
                    ...
                    const domains = this._params.domains
                      .map((domain) => [
                        this.hass.localize(`domain.${domain}`),
                        domain,
                      ])
                      .sort();
      ...
      >
        ...
        <div>
          ${domains.map(
            (domain) => lit_element__WEBPACK_IMPORTED_MODULE_0__["html"]`
                <div>${domain[0]}</div>
