...
(window.webpackJsonp = window.webpackJsonp || []).push([
  [99],
  {
    105: function(t, e, i) {
      ...
      const r = Object(a.a)(
        (t) =>
          class extends t {
            fire(t, e, i) {
              return (i = i || {}), Object(s.a)(i.node || this, t, e, i);
            }
          }
      );
    },
    ...
    172: function(t, e, i) {
      ...
      var a = i(185);
      e.a = (t) =>
        void 0 === t.attributes.friendly_name
          ? Object(a.a)(t.entity_id).replace(/_/g, " ")
    ...
    176: function(t, e, i) {
      ...
      class r extends a {
        constructor(...t) {
          super(...t), (this._iconsetName = void 0);
        }
        listen(t, e, a) {
          super.listen(t, e, a),
            s ||
...
`,
    ...
    286: function(t, e, i) {
      ...
      const a = async (t, e = !1) => {
        ...
        const a = await i.e(123).then(i.t.bind(null, 354, 7));
        a.Icon.Default.imagePath = "/static/images/leaflet/images/";
        const s = a.map(t),
          r = document.createElement("link");
        return (
          r.setAttribute("href", "/static/images/leaflet/leaflet.css"),
          r.setAttribute("rel", "stylesheet"),
          t.parentNode.appendChild(r),
          s.setView([52.3731339, 4.8903147], 13),
          a
            .tileLayer(
              `https://{s}.basemaps.cartocdn.com/${
                e ? "dark_all" : "light_all"
              }/{z}/{x}/{y}${a.Browser.retina ? "@2x.png" : ".png"}`,
              {
                attribution:
    ...
    `;
          ...
          ready() {
            super.ready(),
              this.addEventListener("click", (t) => this.badgeTap(t));
          }
          badgeTap(t) {
            t.stopPropagation(),
              this.entityId &&
    ...
    665: function(t, e, i) {
      ...
      var a = i(3),
        s = i(25),
        r = (i(126), i(176), i(387), i(174)),
        n = i(172),
        o = i(170),
        l = i(286);
      customElements.define(
        "ha-panel-map",
        class extends Object(o.a)(s.a) {
          static get template() {
            return a.a`
    ...
    `;
          ...
          connectedCallback() {
            super.connectedCallback(), this.loadMap();
          }
          async loadMap() {
            ([this._map, this.Leaflet] = await Object(l.a)(this.$.map)),
          ...
          fitMap() {
            ...
            0 === this._mapItems.length
              ...
              : ((t = new this.Leaflet.latLngBounds(
                  this._mapItems.map((t) => t.getLatLng())
                )),
          ...
          drawEntities(t) {
            ...
            if (e) {
              ...
              var i = (this._mapItems = []);
              Object.keys(t.states).forEach((a) => {
                var s = t.states[a],
                  o = Object(n.a)(s);
                if (
                  !(
                    (s.attributes.hidden && "zone" !== Object(r.a)(s)) ||
                    "home" === s.state
                  ) &&
                  "latitude" in s.attributes &&
                  "longitude" in s.attributes
                ) {
                  var l;
                  if ("zone" === Object(r.a)(s)) {
                    if (s.attributes.passive) return;
                    var c = "";
                    if (s.attributes.icon) {
                      const t = document.createElement("ha-icon");
                      t.setAttribute("icon", s.attributes.icon),
                        (c = t.outerHTML);
                    } else c = o;
                    return (
                  ...
                  var d = s.attributes.entity_picture || "",
                    h = o
                      .split(" ")
                      .map(function(t) {
                        return t.substr(0, 1);
                  ...
                  (l = this.Leaflet.divIcon({
                    ...
                    i.push(
                      this.Leaflet.marker(
                        [s.attributes.latitude, s.attributes.longitude],
                        { icon: l, title: Object(n.a)(s) }
                      ).addTo(e)
                    ),
                    s.attributes.gps_accuracy &&
                      i.push(
                        this.Leaflet.circle(
                          [s.attributes.latitude, s.attributes.longitude],
                          {
                            interactive: !1,
                            color: "#0288D1",
                            radius: s.attributes.gps_accuracy,
                          }
                        ).addTo(e)
                      );
                }
