/*! For license information please see chunk.a6948e4d5d4d4cdcc9a3.js.LICENSE */
...
`,
    ...
    655: function(e, t, i) {
      ...
      !(function(e, t, i, n) {
        ...
        if (n) for (var p = 0; p < n.length; p++) o = n[p](o);
        var h = t(function(e) {
        ...
        [Object(n.d)("dialog-domain-toggler")],
        function(e, t) {
          return {
            F: class extends t {
              constructor(...t) {
            ...
            d: [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  const e = this._params.domains
                    .map((e) => [this.hass.localize(`domain.${e}`), e])
                    .sort();
                  return n.f`
      <ha-paper-dialog
        with-backdrop
      ...
      >
        ...
        <div>
          ${e.map(
            (e) => n.f`
                <div>${e[0]}</div>
                <mwc-button .domain=${e[1]} @click=${this._handleOff}>
                  ${this.hass.localize("state.default.off")}
                </mwc-button>
                <mwc-button .domain=${e[1]} @click=${this._handleOn}>
...
//# sourceMappingURL=chunk.a6948e4d5d4d4cdcc9a3.js.map
