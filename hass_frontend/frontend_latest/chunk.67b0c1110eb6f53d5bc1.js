...
`,
        ...
        get _parentNoink() {
          var t = Object(l.a)(this).parentNode;
          return !!t && !!t.noink;
        },
    ...
    267: function(t, e, i) {
      ...
      var n = i(3);
      const o = n.a`<iron-iconset-svg name="paper-tabs" size="24">
<svg><defs>
...
`,
        ...
        _computeScrollButtonClass: function(t, e, i) {
          return !e || i ? "hidden" : t ? "not-visible" : "";
        },
        ...
        _tabChanged: function(t, e) {
          ...
          this._isRTL && (c = !c),
            c
              ? this._positionBar(
                  this._calcPercent(o.left + o.width - s.left, n) - 5,
                  this._left
                )
              : this._positionBar(
                  this._calcPercent(s.left + s.width - o.left, n) - 5,
                  this._calcPercent(a, n) + 5
                ),
            this.scrollable && this._scrollToSelectedIfNeeded(o.width, a);
        },
        _scrollToSelectedIfNeeded: function(t, e) {
          var i = e - this.$.tabsContainer.scrollLeft;
          i < 0
            ? (this.$.tabsContainer.scrollLeft += i)
            : (i += t - this.$.tabsContainer.offsetWidth) > 0 &&
              (this.$.tabsContainer.scrollLeft += i);
        },
