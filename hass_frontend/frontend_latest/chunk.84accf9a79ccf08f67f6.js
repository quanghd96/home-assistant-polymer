...
(window.webpackJsonp = window.webpackJsonp || []).push([
  [36],
  {
        ...
        class extends Object(r.a)(s.a) {
          ...
          connectedCallback() {
            super.connectedCallback(),
              ...
              i ||
                (i = Promise.all([a.e(126), a.e(68)]).then(a.bind(null, 167))),
              i
                .then(
    ...
    152: function(e, t, a) {
      "use strict";
      a(151);
      const s = customElements.get("paper-slider");
      customElements.define(
        "ha-paper-slider",
        class extends s {
          static get template() {
    ...
    154: function(e, t, a) {
      "use strict";
      a(148), a(141), a(106), a(90), a(138), a(140);
      var s = a(3),
        r = a(25),
        i = (a(152), a(105));
      customElements.define(
        "ha-form",
        class extends Object(i.a)(r.a) {
          static get template() {
            return s.a`
      <style>
        .error {
      ...
      const l = {
          getTabbableNodes: function(e) {
            ...
            return this._collectTabbableNodes(e, t)
              ? i.a._sortByTabIndex(t)
              : t;
          },
          _collectTabbableNodes: function(e, t) {
            if (e.nodeType !== Node.ELEMENT_NODE || !i.a._isVisible(e))
              return !1;
            var a,
              s = e,
              l = i.a._normalizedTabIndex(s),
              o = l > 0;
            l >= 0 && t.push(s),
              (a =
                "content" === s.localName || "slot" === s.localName
                  ? Object(r.a)(s).getDistributedNodes()
                  : Object(r.a)(s.shadowRoot || s.root || s).children);
            for (var n = 0; n < a.length; n++)
              o = this._collectTabbableNodes(a[n], t) || o;
            return o;
          },
        },
        ...
        n = {
          get _focusableNodes() {
            return l.getTabbableNodes(this);
          },
        };
      customElements.define(
        "ha-paper-dialog",
        class extends Object(s.b)([n], o) {}
      );
    },
    203: function(e, t, a) {
      "use strict";
...
`,
        ...
        _ensureTarget: function() {
          (this.dialogElement = this.dialogElement || this.parentElement),
            ...
            this.dialogElement.behaviors.indexOf(s.b) >= 0
    ...
    694: function(e, t, a) {
      ...
      var s = a(3),
        r = a(25),
        i = (a(189), a(154), a(149), a(92), a(105)),
        l = a(170);
      let o = 0;
      customElements.define(
        "ha-mfa-module-setup-flow",
        class extends Object(l.a)(Object(i.a)(r.a)) {
          static get template() {
            return s.a`
    ...
    `;
          ...
          showDialog({
            ...
            continueFlowId: t,
            mfaModuleId: a,
            dialogClosedCallback: s,
          }) {
            (this.hass = e),
              (this._instance = o++),
              (this._dialogClosedCallback = s),
              (this._createdFromHandler = !!a),
              (this._loading = !0),
              (this._opened = !0);
            const r = t
                ? this.hass.callWS({ type: "auth/setup_mfa", flow_id: t })
                : this.hass.callWS({
                    type: "auth/setup_mfa",
                    mfa_module_id: a,
                  }),
          ...
          _computeStepAbortedReason(e, t) {
            return e(`component.auth.mfa_setup.${t.handler}.abort.${t.reason}`);
          }
          _computeStepTitle(e, t) {
            return (
              e(
                `component.auth.mfa_setup.${t.handler}.step.${t.step_id}.title`
              ) || "Setup Multi-factor Authentication"
            );
          }
          _computeStepDescription(e, t) {
            const a = [
                `component.auth.mfa_setup.${t.handler}.step.${
                  t.step_id
                }.description`,
              ],
              s = t.description_placeholders || {};
            return (
          ...
          _computeLabelCallback(e, t) {
            return (a) =>
              e(
                `component.auth.mfa_setup.${t.handler}.step.${t.step_id}.data.${
                  a.name
                }`
              ) || a.name;
          }
          _computeErrorCallback(e, t) {
            return (a) =>
              e(`component.auth.mfa_setup.${t.handler}.error.${a}`) || a;
          }
        }
      );
    },
