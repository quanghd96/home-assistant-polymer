...
`,
        ...
        get _stickyEl() {
          ...
          for (
            var t, e = Object(o.a)(this.$.slot).getDistributedNodes(), s = 0;
            (t = e[s]);
            s++
          )
        ...
        _updateScrollState: function(t, e) {
          if (0 !== this._height) {
            var s = 0,
              ...
              n = t - this._lastScrollTop,
              l = Math.abs(n),
              a = t > this._lastScrollTop,
              h = performance.now();
            if (
              (this._mayMove() &&
                (i = this._clamp(this.reveals ? o + n : t, 0, r)),
              t >= this._dHeight &&
                ((i =
              ...
              this.reveals &&
                !this.disabled &&
                l < 100 &&
                ((h - this._initTimestamp > 300 ||
                  this._wasScrollingDown !== a) &&
                  ((this._initScrollTop = t), (this._initTimestamp = h)),
                t >= r))
            )
              if (Math.abs(this._initScrollTop - t) > 30 || l > 10) {
                a && t >= r
                  ? (i = r)
                  : !a &&
                    t >= this._dHeight &&
                    (i = this.condenses && !this.fixed ? this._dHeight : 0);
                var c = n / (h - this._lastTimestamp);
                this.style.transitionDuration =
                  this._clamp((i - o) / c, 0, 300) + "ms";
              } else i = this._top;
            (s = 0 === this._dHeight ? (t > 0 ? 1 : 0) : i / this._dHeight),
              e ||
                ((this._lastScrollTop = t),
                (this._top = i),
                (this._wasScrollingDown = a),
                (this._lastTimestamp = h)),
              (e || s !== this._progress || o !== i || 0 === t) &&
                ((this._progress = s),
                this._runEffects(s, i),
    ...
    241: function(t, e, s) {
      ...
      const o = {
          ...
          if (
            ...
            if ("document" === t) this.scrollTarget = this._doc;
              ...
              this.scrollTarget =
                s && s.$
                  ? s.$[t]
                  : Object(i.a)(this.ownerDocument).querySelector("#" + t);
            } else
        ...
        scroll: function(t, e) {
          var s;
          "object" == typeof t ? ((s = t.left), (e = t.top)) : (s = t),
            (s = s || 0),
            (e = e || 0),
            this.scrollTarget === this._doc
              ? window.scrollTo(s, e)
              : this._isValidScrollTarget() &&
                ((this.scrollTarget.scrollLeft = s),
        ...
        _toggleScrollListener: function(t, e) {
          var s = e === this._doc ? window : e;
          t
            ? this._boundScrollHandler ||
              ((this._boundScrollHandler = this._scrollHandler.bind(this)),
              s.addEventListener("scroll", this._boundScrollHandler))
            : this._boundScrollHandler &&
              (s.removeEventListener("scroll", this._boundScrollHandler),
      ...
      const r = [
        i.a,
        {
          ...
          createEffect: function(t, e) {
            var s = o.a[t];
            if (!s) throw new ReferenceError(this._getUndefinedMsg(t));
            var i = this._boundEffect(s, e || {});
            return i.setUp(), i;
          },
          _effectsChanged: function(t, e, s) {
            this._tearDownEffects(),
              t &&
                s &&
                (t.split(" ").forEach(function(t) {
                  ...
                  "" !== t &&
                    ((s = o.a[t])
                      ? this._effects.push(this._boundEffect(s, e[t]))
            ...
            var s = parseFloat(e.startsAt || 0),
              ...
              n =
                0 === s && 1 === i
                  ? t.run
                  : function(e, i) {
                      t.run.call(this, Math.max(0, (e - s) / o), i);
                    };
            return {
              setUp: t.setUp ? t.setUp.bind(this, e) : r,
              run: t.run ? n.bind(this) : r,
          ...
          _runEffects: function(t, e) {
            this._effectsRunFn &&
              this._effectsRunFn.forEach(function(s) {
                s(t, e);
              });
          },
          _scrollHandler: function() {
