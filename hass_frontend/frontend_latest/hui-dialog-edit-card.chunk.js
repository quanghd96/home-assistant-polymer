...
*/
            ...
            if (tag.toUpperCase() === this._element.tagName) {
              try {
                this._element.setConfig(
                  Object(
                    deep_clone_simple__WEBPACK_IMPORTED_MODULE_1__["default"]
                  )(configValue)
                );
              } catch (err) {
                this._createCard(
  ...
  \************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        let HuiDialogEditCard = _decorate(
          [
            Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])(
              "hui-dialog-edit-card"
            ),
                  ...
                  value: async function _save(cardConf) {
                    ...
                    await lovelace.saveConfig(
                      this._params.path.length === 1
                        ? Object(
                            _config_util__WEBPACK_IMPORTED_MODULE_3__["addCard"]
                          )(lovelace.config, this._params.path, cardConf)
                        : Object(
  ...
  \************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        let HuiDialogPickCard = _decorate(
          [
            Object(lit_element__WEBPACK_IMPORTED_MODULE_0__["customElement"])(
              "hui-dialog-pick-card"
            ),
  ...
  \*****************************************************************/
      ...
      `;
                      preview = lit_element__WEBPACK_IMPORTED_MODULE_0__[
                        "html"
                      ]`
                ...
                },
                {
                  ...
                  value: async function _toggleEditor() {
                    ...
                    if (this._uiEditor) {
                      ...
                      const success = await this._loadConfigElement(
                        this._cardConfig
                      );
                ...
                },
                {
                  ...
                  value: async function _loadConfigElement(conf) {
                    ...
                    try {
                      ...
                      this._errorMsg = lit_element__WEBPACK_IMPORTED_MODULE_0__[
                        "html"
                      ]`
