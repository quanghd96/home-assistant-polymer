              ...
              d: [
                ...
                },
                {
                  ...
                  value() {
                    return Object(
                    ...
                    )((hass, domainFilter, entityFilter) => {
                      let states = [];
                      ...
                      if (entityFilter) {
                        states = states.filter(
                          (
                            stateObj // We always want to include the entity of the current value
                          ) =>
