(window.webpackJsonp = window.webpackJsonp || []).push([
  [21],
  {
    737: function(e, t, i) {
      ...
      i.r(t);
      var n = i(0),
        r = (i(200), i(106), i(147), i(153), i(171), i(181), i(271)),
        o = i(125),
        s = i(457),
        a = i(207),
        c = i(172),
      ...
      const w = (e) => void 0 === e.should_expose || e.should_expose;
      !(function(e, t, i, n) {
        var r = (function() {
          var e = {
        ...
        if (n) for (var o = 0; o < n.length; o++) r = n[o](r);
        var s = t(function(e) {
        ...
        [Object(n.d)("cloud-google-assistant")],
        function(e, t) {
          class i extends t {
            constructor(...t) {
              super(...t), e(this);
          ...
          return {
            ...
            d: [
              ...
              { kind: "field", key: "_popstateSyncAttached", value: () => !1 },
              {
                kind: "field",
              ...
              },
              {
                ...
                key: "render",
                value: function() {
                  if (void 0 === this._entities)
                    return n.f`
        <hass-loading-screen></hass-loading-screen>
      `;
                  const e = Object(s.b)(this.cloudStatus.google_entities),
                    t = this._getEntityFilterFunc(
                      this.cloudStatus.google_entities
                    ),
                    i = this._isInitialExposed || new Set(),
                    r = void 0 === this._isInitialExposed;
                  let o = 0;
                  const a = [],
                    c = [];
                  return (
                    this._entities.forEach((s) => {
                      const d = this.hass.states[s.entity_id],
                        l = this._entityConfigs[s.entity_id] || {},
                        p = e ? w(l) : t(s.entity_id);
                      p && (o++, r && i.add(s.entity_id)),
                        (i.has(s.entity_id) ? a : c).push(n.f`
        <ha-card>
          <div class="card-content">
            ...
            >
              ${s.traits
                .map((e) => e.substr(e.lastIndexOf(".") + 1))
                .join(", ")}
            </state-info>
            <paper-toggle-button
    ...
    `
              ...
              },
              {
                ...
                key: "firstUpdated",
                value: function(e) {
                  b(k(i.prototype), "firstUpdated", this).call(this, e),
                    this._fetchData();
                },
              },
              {
                ...
                key: "updated",
                value: function(e) {
                  b(k(i.prototype), "updated", this).call(this, e),
                    e.has("cloudStatus") &&
                ...
                value: async function() {
                  ...
                  e.sort((e, t) => {
                    const i = this.hass.states[e.entity_id],
                      n = this.hass.states[t.entity_id];
                    return Object(a.b)(
                      i ? Object(c.a)(i) : e.entity_id,
                      n ? Object(c.a)(n) : t.entity_id
                    );
                  }),
                    (this._entities = e);
                },
              },
              {
                ...
                key: "_showMoreInfo",
                value: function(e) {
                  const t = e.currentTarget.stateObj.entity_id;
                  Object(d.a)(this, "hass-more-info", { entityId: t });
                },
              },
              {
                kind: "method",
              ...
              },
              {
                ...
                value: async function(e, t) {
                  t !== w(this._entityConfigs[e] || {}) &&
                    (await this._updateConfig(e, { should_expose: t }),
              ...
              },
              {
                ...
                value: async function(e) {
                  const t = e.currentTarget.entityId,
                    i = e.detail.value;
                  i !== Boolean((this._entityConfigs[t] || {}).disable_2fa) &&
                    (await this._updateConfig(t, { disable_2fa: i }));
                },
              },
              {
                kind: "method",
                key: "_updateConfig",
                value: async function(e, t) {
                  const i = await Object(r.i)(this.hass, e, t);
                ...
                value: function() {
                  Object(p.a)(this, {
                    domains: this._entities
                      .map((e) => Object(u.a)(e.entity_id))
                      .filter((e, t, i) => i.indexOf(e) === t),
                    toggleDomain: (e, t) => {
                      this._entities.forEach((i) => {
                        Object(u.a)(i.entity_id) === e &&
                          this._updateExposed(i.entity_id, t);
                      });
                    },
                  });
                },
              },
              {
                ...
                value: function() {
                  if (this._popstateReloadStatusAttached) return;
                  this._popstateReloadStatusAttached = !0;
                  const e = this.parentElement;
                  window.addEventListener(
                    "popstate",
                    () => Object(d.a)(e, "ha-refresh-cloud-status"),
                    { once: !0 }
                  );
                },
              },
              {
                ...
                value: function() {
                  if (this._popstateSyncAttached) return;
