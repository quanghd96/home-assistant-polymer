...
`;
    ...
    681: function(t, e, r) {
      "use strict";
      r.r(e),
        r.d(e, "HuiIframeCardEditor", function() {
          return h;
        });
      var n = r(0),
        i = (r(90), r(191)),
      ...
      let h = (function(t, e, r, n) {
        ...
        return (
          i.initializeClassElements(a.F, p.elements),
          i.runClassFinishers(a.F, p.finishers)
        );
      })(
    ...
    `
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  const e = t.target;
                  let r = e.value;
                  "aspect_ratio" === e.configValue && e.value && (r += "%"),
                    this[`_${e.configValue}`] !== r &&
                      (e.configValue &&
                        ("" === e.value
...
//# sourceMappingURL=chunk.9ae260c14ca1075f5d32.js.map
