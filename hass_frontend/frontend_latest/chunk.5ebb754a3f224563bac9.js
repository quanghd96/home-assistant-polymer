      ...
      const r = {
          getTabbableNodes: function(t) {
            ...
            return this._collectTabbableNodes(t, e)
              ? n.a._sortByTabIndex(e)
              : e;
          },
          _collectTabbableNodes: function(t, e) {
            if (t.nodeType !== Node.ELEMENT_NODE || !n.a._isVisible(t))
              return !1;
            var i,
              a = t,
              r = n.a._normalizedTabIndex(a),
              o = r > 0;
            r >= 0 && e.push(a),
              (i =
                "content" === a.localName || "slot" === a.localName
                  ? Object(s.a)(a).getDistributedNodes()
                  : Object(s.a)(a.shadowRoot || a.root || a).children);
            for (var d = 0; d < i.length; d++)
              o = this._collectTabbableNodes(i[d], e) || o;
            return o;
          },
        },
    ...
    702: function(t, e, i) {
      ...
      customElements.define(
        ...
        class extends a.a {
          ...
          render() {
            if (!this._params) return a.f``;
            const t = this._params.entry,
              e = this.hass.states[t.entity_id],
              i =
                Object(n.a)(this._entityId.trim()) !==
                Object(n.a)(this._params.entry.entity_id);
            return a.f`
      <ha-paper-dialog
        with-backdrop
        opened
