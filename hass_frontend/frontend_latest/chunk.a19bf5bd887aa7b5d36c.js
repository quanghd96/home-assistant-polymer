/*! For license information please see chunk.a19bf5bd887aa7b5d36c.js.LICENSE */
...
`,
    ...
    171: function(e, t, i) {
      ...
      let p = (function(e, t, i, n) {
        ...
        if (n) for (var d = 0; d < n.length; d++) p = n[d](p);
        var u = t(function(e) {
            p.initializeInstanceElements(e, h.elements);
          }, i),
          h = p.decorateClass(
            (function(e) {
              for (
        ...
        return (
          p.initializeClassElements(u.F, h.elements),
          p.runClassFinishers(u.F, h.finishers)
        );
      })(
        null,
        function(e, t) {
    ...
    `;
      ...
      customElements.define("ha-card", p);
    },
    173: function(e, t, i) {
      "use strict";
      i(4);
    ...
    179: function(e, t, i) {
      ...
      const a = {
          ...
          _onDialogClick: function(e) {
            for (
              var t = Object(o.a)(e).path, i = 0, n = t.indexOf(this);
              i < n;
              i++
            ) {
              var a = t[i];
              if (
                a.hasAttribute &&
                (a.hasAttribute("dialog-dismiss") ||
                  a.hasAttribute("dialog-confirm"))
              ) {
...
`;
      r.setAttribute("strip-whitespace", ""),
        Object(n.a)({ _template: r, is: "paper-spinner", behaviors: [a.a] });
    },
    184: function(e, t, i) {
      "use strict";
    ...
    190: function(e, t, i) {
      ...
      var m = {
          ...
          ZZ: function(e) {
            ...
            return (
              (t > 0 ? "-" : "+") +
              p(100 * Math.floor(Math.abs(t) / 60) + (Math.abs(t) % 60), 4)
            );
          },
        },
        g = {
      ...
      (g.dd = g.d),
        ...
        (n.format = function(e, t, i) {
          ...
          return (t = (t = t.replace(r, function(e, t) {
            ...
            return t in m ? m[t](e, a) : t.slice(1, t.length - 1);
          })).replace(/\?\?/g, function() {
            return s.shift();
          });
        }),
        (n.parse = function(e, t, i) {
          ...
          var r,
            ...
            p = e.match(new RegExp(c, "i"));
          if (!p) return null;
          for (var d = 1; d < p.length; d++) l[d - 1](s, p[d], a);
          var u,
            h = new Date();
          return (
...
`,
  ...
  `;
    ...
    246: function(e, t, i) {
      "use strict";
      i(141);
      const n = customElements.get("paper-dropdown-menu");
...
`,
    ...
    710: function(e, t, i) {
      "use strict";
      i.r(t);
      i(198), i(216), i(177), i(138), i(82), i(145);
      var n = i(3),
        o = i(25),
        a = (i(171), i(126), i(92), i(64)),
        r = i(105),
        s = i(170);
      i(187), i(180);
      customElements.define(
        "ha-change-password-card",
        class extends Object(s.a)(o.a) {
          static get template() {
            return n.a`
    ...
    `;
            ...
            super.ready(),
              this.addEventListener("keypress", (e) => {
                (this._statusMsg = null),
                  13 === e.keyCode && this._changePassword();
              });
          }
          async _changePassword() {
            if (
              ((this._statusMsg = null),
              this._currentPassword && this._password1 && this._password2)
            )
              ...
              else this._errorMsg = "New password confirmation doesn't match";
          }
        }
      );
      let l = !1;
      customElements.define(
        "ha-mfa-modules-card",
        class extends Object(r.a)(Object(s.a)(o.a)) {
          static get template() {
            return n.a`
    ...
    `;
            ...
            super.connectedCallback(),
              l ||
                ...
                this.fire("register-dialog", {
                  ...
                  dialogImport: () =>
                    Promise.all([i.e(9), i.e(36)]).then(i.bind(null, 694)),
                }));
          }
          _enable(e) {
          ...
          _disable(e) {
            if (
              ...
              return;
            const t = e.model.module.id;
            this.hass
              .callWS({ type: "auth/depose_mfa", mfa_module_id: t })
              .then(() => {
    ...
    `;
              ...
              },
              {
                ...
                value: async function(e) {
                  Object(a.b)(this.hass.connection, "core").save({
                    showAdvanced: e.currentTarget.checked,
                  });
                },
              },
              {
    ...
    `;
      ...
      customElements.define(
        ...
        class extends Object(s.a)(Object(r.a)(o.a)) {
          static get template() {
            return n.a`
      <style>
        paper-icon-button {
    ...
    `;
          ...
          _computeTokens(e) {
            return e.filter((e) => "normal" === e.type).reverse();
          }
          _formatTitle(e) {
          ...
          _formatCreatedAt(e) {
            return this.localize(
              ...
              "date",
              Object(g.a)(new Date(e), this.hass.language)
            );
          }
          _formatLastUsed(e) {
            return e.last_used_at
              ? this.localize(
                  ...
                  "date",
                  Object(g.a)(new Date(e.last_used_at), this.hass.language),
                  "location",
                  e.last_used_ip
                )
            ...
            if (
              ...
              try {
                await this.hass.callWS({
                  ...
                  refresh_token_id: e.model.item.id,
                }),
    ...
    `;
          ...
          _computeTokens(e) {
            return e
              .filter((e) => "long_lived_access_token" === e.type)
              .reverse();
          }
          _formatTitle(e) {
            return this.localize(
    ...
    `;
          ...
          static get properties() {
            return {
              ...
              languages: { type: Array, computed: "computeLanguages(hass)" },
            };
          }
          ...
          computeLanguages(e) {
            ...
            const t = e.translationMetadata.translations;
            return Object.keys(t).map((e) => Object.assign({ key: e }, t[e]));
          }
          setLanguageSelection(e) {
            this.languageSelection = e;
          }
          languageSelectionChanged(e) {
    ...
    `;
          ...
          static get properties() {
            return {
              hass: Object,
              narrow: Boolean,
              _hasThemes: { type: Boolean, computed: "_compHasThemes(hass)" },
          ...
          _compHasThemes(e) {
            return (
              e.themes && e.themes.themes && Object.keys(e.themes.themes).length
            );
          }
          ready() {
            super.ready(),
          ...
          selectionChanged(e, t) {
            t > 0 && t < this.themes.length
              ...
              : 0 === t && "" !== e.selectedTheme && this.fire("settheme", "");
          }
        }
      );
      i(173), i(4);
      ...
      const b = Object(y.a)({
        ...
        _generateLabelId: function() {
          if (!this.id) {
            var e = "iron-label-" + b._labelNumber++;
            Object(v.a)(this).setAttribute("id", e);
          }
        },
        _findTarget: function() {
          if (this.for) {
            var e = Object(v.a)(this).getOwnerRoot();
            return Object(v.a)(e).querySelector("#" + this.for);
          }
          var t = Object(v.a)(this).querySelector("[iron-label-target]");
          return t || (t = Object(v.a)(this).firstElementChild), t;
        },
        ...
        _applyLabelledBy: function() {
          this._forElement &&
            Object(v.a)(this._forElement).setAttribute(
              "aria-labelledby",
              this.id
            );
        },
        _forChanged: function() {
          this._forElement &&
            Object(v.a)(this._forElement).removeAttribute("aria-labelledby"),
      ...
      i(200);
      const _ = async (e) => {
          const t = await e.callWS({ type: "notify/html5/appkey" });
          return t
            ? (function(e) {
    ...
    `;
          ...
          async connectedCallback() {
            if ((super.connectedCallback(), k))
              try {
                const t = await navigator.serviceWorker.ready;
                if (!t.pushManager) return;
                t.pushManager.getSubscription().then((e) => {
                  (this.loading = !1), (this.pushChecked = !!e);
                });
              } catch (e) {}
          }
          handlePushChange(e) {
            ...
            try {
              ...
              o =
                navigator.userAgent.toLowerCase().indexOf("firefox") > -1
                  ? "firefox"
                  : "chrome";
              const a = prompt("What should this device be called ?");
              if (null == a) return void (this.pushChecked = !1);
              let r;
              try {
                r = await _(this.hass);
              } catch (i) {
              ...
              (t = r
                ...
                : await e.pushManager.subscribe({ userVisibleOnly: !0 })),
              ...
              const e = n.message || "Notification registration failed.";
              t && (await t.unsubscribe()),
                console.error(n),
                this.fire("hass-notification", { message: e }),
                (this.pushChecked = !1);
            }
          }
          async unsubscribePushNotifications() {
            ...
            try {
              ...
              const e =
                t.message || "Failed unsubscribing for push notifications.";
              console.error("Error in unsub push", t),
                this.fire("hass-notification", { message: e }),
                (this.pushChecked = !0);
            }
          }
    ...
    `;
          ...
          static get properties() {
            return {
              ...
              _pushSupported: { type: Boolean, value: k },
              _error: {
                type: Boolean,
          ...
          _compPlatformLoaded(e) {
            return Object(w.a)(e, "notify.html5");
          }
          _compError(e, t) {
            return !e || !t;
          }
            ...
            return (
              (i = t
                ? e
                  ...
                  : "error_load_platform"
                : "error_use_https"),
              this.localize(`ui.panel.profile.push_notifications.${i}`)
            );
          }
        }
      );
            ...
            (function(e) {
              for (
                ...
                var o,
                  a = e[n];
                if ("method" === a.kind && (o = t.find(i)))
                  if (O(a.descriptor) || O(o.descriptor)) {
                    if (A(a) || A(o))
                      throw new ReferenceError(
                        "Duplicated methods (" + a.key + ") can't be decorated."
                      );
    ...
    `;
              ...
              },
              {
                ...
                value: async function(e) {
                  ...
                  t !== ("always_hidden" === this.hass.dockedSidebar) &&
                    Object(x.a)(this, "hass-dock-sidebar", {
                      dock: t ? "always_hidden" : "auto",
                    });
                },
              },
            ],
    ...
    `;
          ...
          connectedCallback() {
            super.connectedCallback(),
              ...
              (this._unsubCoreData = Object(a.b)(
                this.hass.connection,
                "core"
              ).subscribe((e) => {
                this._coreUserData = e;
              }));
          }
          ...
          _canChangePassword(e) {
            return e.credentials.some(
...
//# sourceMappingURL=chunk.a19bf5bd887aa7b5d36c.js.map
