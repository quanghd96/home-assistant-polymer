...
`,
    ...
    349: function(e, t, i) {
      ...
      (n.LOGIC_STATE_ATTRIBUTES = n.LOGIC_STATE_ATTRIBUTES || {
    ...
    `;
          ...
          computeShowNoDevices(e) {
            return "no-devices" === e;
          }
          computeShowSpinner(e) {
            return "loading" === e || "saving" === e;
          }
          computeShowPlaceholder(e) {
            return "editing" !== e;
          }
          computeShowForm(e) {
            return "editing" === e;
          ...
          entitiesChanged(e, t) {
            if (0 !== e.length)
              if (t) {
                var i = t[this.selectedEntity].entity_id,
                  n = e.findIndex(function(e) {
                    return e.entity_id === i;
                  });
                -1 === n
                  ? (this.selectedEntity = 0)
                  : n !== this.selectedEntity && (this.selectedEntity = n);
    ...
    `;
          ...
          getOptions(e) {
            const t = e.domain || "*",
              i = e.options[t] || e.options["*"];
            return i
              ? i.sort()
              : ((this.item.type = "string"), this.fire("item-changed"), []);
          }
          computeSelected(e) {
    ...
    `;
          ...
          tapButton() {
            this.item.secondary
              ? (this.item = Object.assign({}, this.item, { secondary: !1 }))
          ...
          itemObserver(e) {
            const t = this.$.wrapper,
              i = r.a.TYPE_TO_TAG[e.type].toUpperCase();
            let n;
            t.lastChild && t.lastChild.tagName === i
              ? (n = t.lastChild)
              : (t.lastChild && t.removeChild(t.lastChild),
                (this.$.child = n = document.createElement(i.toLowerCase())),
                (n.className = "form-control"),
                n.addEventListener("item-changed", () => {
                  this.item = Object.assign({}, n.item);
                })),
              n.setProperties({ item: this.item }),
              null === n.parentNode && t.appendChild(n);
          }
        }
      );
      customElements.define(
    ...
    `;
          ...
          _initOpenObject(e, t, i, n) {
            return Object.assign(
              {
                attribute: e,
                value: t,
                closed: !1,
                domain: Object(c.a)(this.entity),
                secondary: i,
                description: e,
              },
              n
          ...
          loadEntity(e) {
            return (
              ...
              this.hass
                ...
                .then((e) => {
                  (this.localConfig = e.local),
                    (this.globalConfig = e.global),
                    (this.newAttributes = []);
                })
            );
          }
          saveEntity() {
            ...
            this.localAttributes
              ...
              .forEach((t) => {
                if (t.closed || t.secondary || !t.attribute || !t.value) return;
                const i = "json" === t.type ? JSON.parse(t.value) : t.value;
                i && (e[t.attribute] = i);
              });
            const t = this.entity.entity_id;
            return this.hass.callApi("POST", "config/customize/config/" + t, e);
          }
          _computeSingleAttribute(e, t, i) {
            const n = r.a.LOGIC_STATE_ATTRIBUTES[e] || {
              type: r.a.UNKNOWN_TYPE,
            };
            return this._initOpenObject(
              e,
              "json" === n.type ? JSON.stringify(t) : t,
              i,
              n
            );
          }
          _computeAttributes(e, t, i) {
            return t.map((t) => this._computeSingleAttribute(t, e[t], i));
          }
          computeLocalAttributes(e) {
            if (!e) return [];
            const t = Object.keys(e);
            return this._computeAttributes(e, t, !1);
          }
          computeGlobalAttributes(e, t) {
            if (!e || !t) return [];
            const i = Object.keys(e),
              n = Object.keys(t).filter((e) => !i.includes(e));
            return this._computeAttributes(t, n, !0);
          }
          computeExistingAttributes(e, t, i) {
            if (!e || !t || !i) return [];
            const n = Object.keys(e),
              o = Object.keys(t),
              a = Object.keys(i.attributes).filter(
                (e) => !n.includes(e) && !o.includes(e)
              );
            return this._computeAttributes(i.attributes, a, !0);
          }
          computeShowWarning(e, t) {
            return (
              !(!e || !t) &&
              Object.keys(e).some(
                (i) => JSON.stringify(t[i]) !== JSON.stringify(e[i])
              )
            );
          }
          filterFromAttributes(e) {
            return (t) => !e || e.every((e) => e.attribute !== t || e.closed);
          }
          getNewAttributesOptions(e, t, i, n) {
            return Object.keys(r.a.LOGIC_STATE_ATTRIBUTES)
              .filter((e) => {
                const t = r.a.LOGIC_STATE_ATTRIBUTES[e];
                return (
                  t &&
                  (!t.domains ||
                    !this.entity ||
                    t.domains.includes(Object(c.a)(this.entity)))
                );
              })
          ...
          selectedNewAttributeObserver(e) {
            if (e < 0) return;
            const t = this.newAttributesOptions[e];
            if (e === this.newAttributesOptions.length - 1) {
              const e = this._initOpenObject("", "", !1, {
                type: r.a.ADD_TYPE,
              });
              return (
                this.push("newAttributes", e),
                void (this.selectedNewAttribute = -1)
              );
            }
            let i = this.localAttributes.findIndex((e) => e.attribute === t);
            if (i >= 0)
              return (
            ...
            if (
              (i = this.globalAttributes.findIndex((e) => e.attribute === t)) >=
              0
            )
              return (
            ...
            if (
              (i = this.existingAttributes.findIndex(
                (e) => e.attribute === t
              )) >= 0
            )
              return (
            ...
            if (
              (i = this.newAttributes.findIndex((e) => e.attribute === t)) >= 0
            )
              return (
                this.set("newAttributes." + i + ".closed", !1),
                void (this.selectedNewAttribute = -1)
              );
            const n = this._computeSingleAttribute(t, "", !1);
            this.push("newAttributes", n), (this.selectedNewAttribute = -1);
          }
          attributesObserver() {
            (this.hasLocalAttributes =
              this.localAttributes &&
              this.localAttributes.some((e) => !e.closed)),
              (this.hasGlobalAttributes =
                this.globalAttributes &&
                this.globalAttributes.some((e) => !e.closed)),
              (this.hasExistingAttributes =
                this.existingAttributes &&
                this.existingAttributes.some((e) => !e.closed)),
              (this.hasNewAttributes =
                this.newAttributes &&
                this.newAttributes.some((e) => !e.closed)),
