...
<div id="checkboxLabel"><slot></slot></div>`;
    ...
    171: function(e, t, i) {
      ...
      let p = (function(e, t, i, n) {
        ...
        var h = t(function(e) {
            p.initializeInstanceElements(e, u.elements);
          }, i),
          u = p.decorateClass(
            (function(e) {
              for (
        ...
        return (
          p.initializeClassElements(h.F, u.elements),
          p.runClassFinishers(h.F, u.finishers)
        );
      })(
        null,
        function(e, t) {
...
`,
    ...
    666: function(e, t, i) {
      ...
      var n = i(3),
        o = i(25),
        a = (i(126), i(278), i(171), i(170));
      customElements.define(
        "ha-panel-shopping-list",
        class extends Object(a.a)(o.a) {
          static get template() {
            return n.a`
    ...
    `;
          ...
          _addItem(e) {
            this.hass
              ...
              .catch(() => this._fetchData()),
              (this.$.addBox.value = ""),
              e && setTimeout(() => this.$.addBox.focus(), 10);
          }
          _addKeyPress(e) {
            13 === e.keyCode && this._addItem();
          }
          _saveEdit(e) {
            const { index: t, item: i } = e.model,
              n = e.target.value;
            n !== i.name &&
              (this.set(["items", t, "name"], n),
              this.hass
                .callApi("post", "shopping_list/item/" + i.id, { name: n })
                .catch(() => this._fetchData()));
          }
          _clearCompleted() {
