  ...
  [76],
  {
    ...
    171: function(e, t, r) {
      ...
      let d = (function(e, t, r, i) {
            ...
            decorateElement: function(e, t) {
              for (
                ...
                var s = this.fromElementDescriptor(e),
                  l = this.toElementFinisherExtras((0, a[n])(s) || s);
                (e = l.element),
          ...
          u = d.decorateClass(
            (function(e) {
              for (
                ...
                var a,
                  l = e[i];
                if ("method" === l.kind && (a = t.find(r)))
                  if (s(l.descriptor) || s(a.descriptor)) {
                    if (o(l) || o(a))
                      throw new ReferenceError(
                        "Duplicated methods (" + l.key + ") can't be decorated."
                      );
                    a.descriptor = l.descriptor;
                  } else {
                    if (o(l)) {
                      if (o(a))
                        throw new ReferenceError(
        ...
        return (
          d.initializeClassElements(h.F, u.elements),
          d.runClassFinishers(h.F, u.finishers)
        );
      })(
        null,
        function(e, t) {
    ...
    730: function(e, t, r) {
      "use strict";
      r.r(t);
      r(198), r(216), r(145), r(140), r(148), r(138);
      var i = r(3),
        a = r(25),
        n = r(332),
        o = r.n(n),
        s = r(462),
        l = r.n(s),
        c = (r(126), r(171), r(92), r(221)),
        d = r(656),
        p = r(105);
      d.a.setLocalizer(d.a.momentLocalizer(o.a));
      const h = "month";
      customElements.define(
        "ha-big-calendar",
        class extends Object(p.a)(a.a) {
          static get template() {
            return i.a`
      <link
        rel="stylesheet"
    ...
    `;
          ...
          _update(e) {
            const t = d.a.Views.values,
              r = c.default.createElement(d.a, {
                events: e,
                views: t,
                popup: !0,
                onNavigate: (e, t) =>
                  this.fire("navigate", { date: e, viewName: t }),
                onView: (e) => this.fire("view-changed", { viewName: e }),
                eventPropGetter: this._setEventStyle,
                defaultView: h,
                defaultDate: new Date(),
              });
            Object(c.render)(r, this.$.root);
          }
          _setEventStyle(e) {
            const t = {};
    ...
    `;
          ...
          static get properties() {
            return {
              hass: Object,
              currentView: { type: String, value: f },
          ...
          connectedCallback() {
            super.connectedCallback(), this._fetchCalendars();
          }
          _fetchCalendars() {
            this.hass.callApi("get", "calendars").then((e) => {
              (this.calendars = e),
                (this.selectedCalendars = e.map((e) => e.entity_id));
            });
          }
          _fetchData() {
            const e = l.a.firstVisibleDay(this.currentDate).toISOString(),
              t = l.a.lastVisibleDay(this.currentDate).toISOString(),
              r = encodeURI(`?start=${e}&end=${t}`),
              i = this.selectedCalendars.map((e) =>
                this.hass.callApi("get", `calendars/${e}${r}`)
              );
          ...
          _getDateRange() {
            ...
            return (
              "day" === this.currentView
                ? ((e = o()(this.currentDate).startOf("day")),
                  (t = o()(this.currentDate).startOf("day")))
                : "week" === this.currentView
                ? ((e = o()(this.currentDate).startOf("isoWeek")),
                  (t = o()(this.currentDate).endOf("isoWeek")))
                : "month" === this.currentView
                ? ((e = o()(this.currentDate)
                    .startOf("month")
                    .subtract(7, "days")),
                  (t = o()(this.currentDate)
                    .endOf("month")
                    .add(7, "days")))
