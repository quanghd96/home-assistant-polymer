...
`,
            ...
            decorateElement: function(e, t) {
              for (
                ...
                var s = this.fromElementDescriptor(e),
                  c = this.toElementFinisherExtras((0, n[o])(s) || s);
                (e = c.element),
    ...
    `
              ...
              },
              {
                ...
                value: function(e) {
                  const t = e.target;
                  if ("" === t.value) return;
                  const i = this.entities.concat({ entity: t.value });
                  (t.value = ""),
                    Object(n.a)(this, "entities-changed", { entities: i });
                },
              },
              {
                kind: "method",
                ...
                value: function(e) {
                  ...
                  "" === t.value
                    ? i.splice(t.index, 1)
                    : (i[t.index] = Object.assign({}, i[t.index], {
                        entity: t.value,
                      })),
                    Object(n.a)(this, "entities-changed", { entities: i });
                },
    ...
    268: function(e, t, i) {
      ...
      var r = i(3),
        n = i(25),
        o = (i(106), i(90), i(138), i(220), i(105));
    ...
    `;
          ...
          _hassChanged(e, t) {
            ...
            Object.keys(e.services)
              .sort()
              .forEach((t) => {
                const r = Object.keys(e.services[t]).sort();
                for (let e = 0; e < r.length; e++) i.push(`${t}.${r[e]}`);
              }),
              (this._services = i);
          }
        }
    ...
    404: function(e, t, i) {
      "use strict";
      var r = i(0),
        n = (i(209), i(141), i(138), i(140), i(268), i(19));
      function o(e) {
        var t,
          i = d(e.key);
        "method" === e.kind
    ...
    `
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  const t = e.target;
                  (this.config &&
                    this.config[this[`${t.configValue}`]] === t.value) ||
                    ("action" === t.configValue &&
                      (this.config = { action: "none" }),
                    t.configValue &&
                      ((this.config = Object.assign({}, this.config, {
                        [t.configValue]: t.value,
                      })),
                      Object(n.a)(this, "action-changed")));
                },
              },
            ],
          };
    ...
    678: function(e, t, i) {
      "use strict";
      i.r(t),
        i.d(t, "HuiEntityButtonCardEditor", function() {
          return m;
        });
      var r = i(0),
        n = (i(90), i(404), i(275), i(240), i(191)),
        o = i(405),
        a = i(19),
        s = i(208);
      function c(e) {
      ...
      const f = Object(n.a)({
        ...
        show_icon: "boolean?",
        icon_height: "string?",
        tap_action: n.a.optional(o.a),
        hold_action: n.a.optional(o.a),
        theme: "string?",
      });
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  if (
                    ...
                    this[`_${t.configValue}`] !== t.config
                  ) {
                    if (t.configValue)
                      if ("" === t.value) delete this._config[t.configValue];
                      else {
                        let e;
