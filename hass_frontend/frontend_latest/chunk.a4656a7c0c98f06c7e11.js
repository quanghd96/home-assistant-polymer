    ...
    179: function(t, e, o) {
      ...
      const a = {
          ...
          _onDialogClick: function(t) {
            for (
              var e = Object(n.a)(t).path, o = 0, i = e.indexOf(this);
              o < i;
              o++
            ) {
              var a = e[o];
      ...
      const s = {
          ...
          _collectTabbableNodes: function(t, e) {
            ...
            for (var r = 0; r < o.length; r++)
              l = this._collectTabbableNodes(o[r], e) || l;
            return l;
          },
        },
...
`,
    ...
    <style include="ha-style-dialog">
      ...
      `;
          ...
          ready() {
            super.ready(),
              this.addEventListener("iron-overlay-closed", (t) =>
                this._dialogClosed(t)
              );
          }
          showDialog({
            _ozwLog: t,
            ...
            _tail: o,
            _numLogLines: i,
            dialogClosedCallback: n,
          }) {
            (this.hass = e),
              (this._ozwLog = t),
              (this._opened = !0),
              (this._dialogClosedCallback = n),
              (this._numLogLines = i),
