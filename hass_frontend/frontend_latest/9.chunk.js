...
`,
          ...
          get target() {
            ...
            )(this).parentNode; // If the parentNode is a document fragment, then we need to use the host.

            var ownerRoot = Object(
              _polymer_polymer_lib_legacy_polymer_dom_js__WEBPACK_IMPORTED_MODULE_2__[
                "dom"
              ]
            )(this).getOwnerRoot();
            ...
            if (this.for) {
              ...
              )(ownerRoot).querySelector("#" + this.for);
            } else {
              target =
          ...
          updatePosition: function() {
            ...
            var horizontalCenterOffset =
              (targetRect.width - thisRect.width) / 2;
            var verticalCenterOffset =
              (targetRect.height - thisRect.height) / 2;
            ...
            if (this.fitToVisibleBounds) {
              ...
              if (
                ...
                this.style.bottom =
                  parentRect.height - targetTop + offset + "px";
                this.style.top = "auto";
              } else {
