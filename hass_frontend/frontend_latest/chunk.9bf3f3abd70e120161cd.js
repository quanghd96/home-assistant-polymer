/*! For license information please see chunk.9bf3f3abd70e120161cd.js.LICENSE */
    ...
    456: function(t, e, i) {
      t.exports = (function(t) {
        ...
        function l(t) {
          ...
          var a = 0.4124 * e + 0.3576 * i + 0.1805 * n,
            o = 0.2126 * e + 0.7152 * i + 0.0722 * n,
            r = 0.0193 * e + 0.1192 * i + 0.9505 * n;
        ...
        var F = S,
          ...
          O = {
            ...
            getAlpha: function(t) {
              var e = R(t);
              return e ? e[3] : (e = B(t)) ? e[3] : (e = z(t)) ? e[3] : void 0;
            },
        ...
        function R(t) {
          if (t) {
            ...
            if (n) {
              ...
              for (var o = 0; o < e.length; o++) e[o] = parseInt(n[o + 1]);
              i = parseFloat(n[4]);
            } else if (
              (n = t.match(
                /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/i
            ...
            for (var o = 0; o < e.length; o++) e[o] = E(e[o], 0, 255);
          ...
          if (t) {
            ...
            if (e) {
              var i = parseFloat(e[4]),
                n = E(parseInt(e[1]), 0, 360),
                a = E(parseFloat(e[2]), 0, 100),
                o = E(parseFloat(e[3]), 0, 100),
                r = E(isNaN(i) ? 1 : i, 0, 1);
              return [n, a, o, r];
            }
          }
        ...
        var Wt = pt.extend({
          ...
          Ht = Tt,
          jt = Wt;
        (Nt.Arc = Vt), (Nt.Line = Et), (Nt.Point = Ht), (Nt.Rectangle = jt);
            ...
            _getStacks: function(t) {
              ...
              for (e = 0; e < r; ++e)
                (i = n.getDatasetMeta(e)).bar &&
                  ...
                  (!1 === o ||
                    (!0 === o && -1 === s.indexOf(i.stack)) ||
                    (void 0 === o &&
                      (void 0 === i.stack || -1 === s.indexOf(i.stack)))) &&
                  s.push(i.stack);
              return s;
            },
        ...
        var Kt = Mt.extend({
            ...
            _resolveElementOptions: function(t, e) {
              ...
              for (i = 0, n = f.length; i < n; ++i)
                h[(a = f[i])] = Xt([l[a], s[a], d[a]], c, e);
              return (
                (h.radius = Xt(
                  [l.radius, u ? u.r : void 0, s.radius, d.radius],
                  c,
                  e
                )),
                h
        ...
        var ne = Mt.extend({
            ...
            _resolvePointOptions: function(t, e) {
              var i,
                ...
                c = Object.keys(h);
              for (i = 0, n = c.length; i < n; ++i)
                (a = c[i]), (d[a] = te([s[a], r[h[a]], r[a], l[a]], u, e));
              return d;
            },
        ...
        var de = Mt.extend({
          ...
          _resolvePointOptions: function(t, e) {
            var i,
              ...
              c = Object.keys(h);
            for (i = 0, n = c.length; i < n; ++i)
              (a = c[i]), (d[a] = le([s[a], r[h[a]], r[a], l[a]], u, e));
            return d;
          },
          _resolveLineOptions: function(t) {
            var e,
        ...
        function ce(t, e) {
          ...
          for (n = 0, o = s.length; n < o; ++n)
            if (t.isDatasetVisible(n))
              for (
                i = t.getDatasetMeta(n), a = 0, r = i.data.length;
                a < r;
                ++a
              ) {
                var l = i.data[a];
            ...
            update: function(t, e, i) {
              if (t) {
                ...
                var g,
                  ...
                  w = b,
                  M = x,
                  _ = { top: s, left: o, bottom: l, right: r },
                  C = [];
                ut.each(v, function(t) {
                  var e,
                    i = t.isHorizontal();
                  i
                    ? ((e = t.update(t.fullWidth ? b : w, x / 2)),
                      (M -= e.height))
                    : ((e = t.update(k, M)), (w -= e.width)),
                    C.push({ horizontal: i, width: e.width, box: t });
                }),
                  (g = (function(t) {
                    var e = 0,
                      i = 0,
                  ...
                  ut.each(p, function(t) {
                    var e = ut.findNextWhere(C, function(e) {
                      ...
                      i = { left: 0, right: 0, top: _.top, bottom: _.bottom };
                    e && t.update(e.width, M, i);
                  }),
                  ye(v, (_ = { top: s, left: o, bottom: l, right: r }));
                var S = Math.max(g.left - _.left, 0);
                (_.left += S), (_.right += Math.max(g.right - _.right, 0));
                var P = Math.max(g.top - _.top, 0);
                (_.top += P), (_.bottom += Math.max(g.bottom - _.bottom, 0));
                var I = i - _.top - _.bottom,
                  A = e - _.left - _.right;
                (A === w && I === M) ||
                  (ut.each(p, function(t) {
                    t.height = I;
              ...
              function F(t) {
                ...
                if (e)
                  if (e.horizontal) {
                    var i = {
                      left: Math.max(_.left, g.left),
                      right: Math.max(_.right, g.right),
                      top: 0,
                      bottom: 0,
                    };
                    t.update(t.fullWidth ? b : w, x / 2, i);
                  } else t.update(e.width, M);
              }
              function L(t) {
                t.isHorizontal()
                  ? ((t.left = t.fullWidth ? o : _.left),
                    (t.right = t.fullWidth ? e - r : _.left + w),
                    (t.top = T),
                    (t.bottom = T + t.height),
                    (T = t.bottom))
                  : ((t.left = D),
              ...
              ((n = function() {
                if (s.resizer) {
                  var n = i.options.maintainAspectRatio && t.parentNode,
                    a = n ? n.clientWidth : 0;
                  e(Oe("resize", i)),
                    n && n.clientWidth < a && i.canvas && e(Oe("resize", i));
                }
              }),
              (o = !1),
              (r = []),
                ...
                this._plugins.concat(a.plugins || []).forEach(function(t) {
                  ...
                  if (-1 === e) {
                    var a = t.id,
                      r = o[a];
                    !1 !== r &&
                      (!0 === r && (r = ut.clone(st.global.plugins[a])),
                      i.push(t),
                      n.push({ plugin: t, options: r || {} }));
                  }
                }),
                (e.descriptors = n),
                (e.id = this._cacheId),
        ...
        var Ze = pt.extend({
            ...
            getTitle: function() {
              var t = this._options,
                e = t.callbacks,
                i = e.beforeTitle.apply(this, arguments),
                n = e.title.apply(this, arguments),
                a = e.afterTitle.apply(this, arguments),
                o = [];
              return (o = Ye(o, Ue(i))), (o = Ye(o, Ue(n))), (o = Ye(o, Ue(a)));
            },
            ...
            handleEvent: function(t) {
              ...
              return (
                ...
                (n = !ut.arrayEquals(e._active, e._lastActive)) &&
        ...
        ut.extend(ni.prototype, {
          ...
          updateLayout: function() {
            !1 !== Ee.notify(this, "beforeLayout") &&
              (we.update(this, this.width, this.height),
          ...
          handleEvent: function(t) {
            ...
            return (
              ...
              (a = !ut.arrayEquals(e.active, e.lastActive)),
            ...
            formatters: {
              ...
              linear: function(t, e, i) {
                ...
                var a = ut.log10(Math.abs(n)),
                  o = "";
                if (0 !== t) {
                  var r = Math.max(Math.abs(i[0]), Math.abs(i[i.length - 1]));
                  if (r < 1e-4) {
                    var s = ut.log10(Math.abs(t));
                    o = t.toExponential(Math.floor(s) - Math.floor(a));
                  } else {
              ...
              if (a.display && s) {
                ...
                if (((t._maxLabelLines = v), (t.longestLabelWidth = m), d)) {
                  var y = ut.toRadians(t.labelRotation),
                    k = Math.cos(y),
                    w = Math.sin(y),
                    M = w * m + h.lineHeight * v + b;
                  (e.height = Math.min(t.maxHeight, e.height + M + x)),
                    (t.ctx.font = h.string);
                  var _,
                    C,
                    S = ci(t.ctx, i[0], h.string),
                    P = ci(t.ctx, i[i.length - 1], h.string),
                    I = t.getPixelForTick(0) - t.left,
                    A = t.right - t.getPixelForTick(i.length - 1);
                  0 !== t.labelRotation
                    ? ((_ = "bottom" === l ? k * S : k * b),
                      (C = "bottom" === l ? k * b : k * P))
                    : ((_ = S / 2), (C = P / 2)),
                    (t.paddingLeft = Math.max(_ - I, 0) + 3),
                    (t.paddingRight = Math.max(C - A, 0) + 3);
                } else
                  a.mirror ? (m = 0) : (m += x + b),
            ...
            getPixelForTick: function(t) {
              ...
              if (e.isHorizontal()) {
                var n = e.width - (e.paddingLeft + e.paddingRight),
                  a = n / Math.max(e._ticks.length - (i ? 0 : 1), 1),
                  o = a * t + e.paddingLeft;
                i && (o += a / 2);
                var r = e.left + o;
            ...
            draw: function(t) {
              ...
              if (e._isVisible()) {
                var n,
                  ...
                  C = u.padding,
                  S = u.labelOffset,
                  P = c.drawTicks ? c.tickMarkLength : 0,
                  I = di(f.fontColor, d),
                  A = b(f),
                  D = ut.options.toPadding(f.padding),
                  T = ut.toRadians(e.labelRotation),
                  F = [],
                  L = c.drawBorder ? ui(c.lineWidth, 0, 0) : 0,
                  O = ut._alignPixel;
                if (
                  ("top" === g
                    ? ((n = O(r, e.bottom, L)),
                      ...
                      (o = n - L / 2))
                    : "bottom" === g
                    ? ((n = O(r, e.top, L)), (a = n + L / 2), (o = e.top + P))
                    : "left" === g
                    ? ((n = O(r, e.right, L)),
                      (a = e.right - P),
                      (o = n - L / 2))
                  ...
                  ut.each(x, function(n, s) {
                    if (!ut.isNullOrUndef(n.label)) {
                      var l,
                        ...
                        B,
                        z = n.label;
                      s === e.zeroLineIndex && i.offset === c.offsetGridLines
                        ? ((l = c.zeroLineWidth),
                          (d = c.zeroLineColor),
                          (u = c.zeroLineBorderDash || []),
                          (h = c.zeroLineBorderDashOffset || 0))
                        : ((l = ui(c.lineWidth, s)),
                          (d = ui(c.color, s)),
                          (u = c.borderDash || []),
                          (h = c.borderDashOffset || 0));
                      var W = ut.isArray(z) ? z.length : 1,
                        N = (function(t, e, i) {
                  ...
                  ut.each(F, function(t) {
                    ...
                    if (
                      ...
                      s.save(),
                        ...
                        s.rotate(t.rotation),
                        (s.font = t.major ? _.string : k.string),
                        (s.fillStyle = t.major ? M : y),
                  ...
                  if (v)
                    ...
                    var N = "left" === g;
                    (R = N ? e.left + W + D.top : e.right - W - D.top),
                      (B = e.top + (e.bottom - e.top) / 2),
                ...
                if (L) {
                  var V,
                    ...
                    j,
                    q = L,
                    Y = ui(c.lineWidth, x.length - 1, 0);
                  v
                    ? ((V = O(r, e.left, q) - q / 2),
                      (E = O(r, e.right, Y) + Y / 2),
                      (H = j = n))
                    : ((H = O(r, e.top, q) - q / 2),
                      (j = O(r, e.bottom, Y) + Y / 2),
                      (V = E = n)),
                    (s.lineWidth = L),
                    (s.strokeStyle = ui(c.color, 0)),
                    s.beginPath(),
                    s.moveTo(V, H),
                    s.lineTo(E, j),
                    s.stroke();
          ...
          gi = fi.extend({
            ...
            getPixelForValue: function(t, e) {
              ...
              if (n.isHorizontal()) {
                var l = n.width / o,
                  d = l * (e - n.minIndex);
                return a && (d += l / 2), n.left + d;
              }
              var u = n.height / o,
                h = u * (e - n.minIndex);
              return a && (h += u / 2), n.top + h;
            },
            getPixelForTick: function(t) {
            ...
            buildTicks: function() {
              var t = this,
                ...
                a = {
                  ...
                  stepSize: ut.valueOrDefault(i.fixedStepSize, i.stepSize),
                },
            ...
            determineDataLimits: function() {
              ...
              if (
                ...
                ut.each(a, function(n, a) {
                  ...
                  void 0 === l[s] &&
                    (l[s] = { positiveValues: [], negativeValues: [] });
                  var d = l[s].positiveValues,
                    u = l[s].negativeValues;
        ...
        var Ci = fi.extend({
            ...
            getPixelForValue: function(t) {
              ...
              return (
                ...
                t !== n &&
                  (0 === n &&
                    ((h = wi(s.fontSize, st.global.defaultFontSize)),
                    (e -= h),
                    (n = u)),
                    ...
                    for (var h = Ti(t) - 1; h >= 0; h--) {
                      ...
                      if (o.display) {
                        ...
                        var m = t.getIndexAngle(h),
                          v = ut.toDegrees(m);
                        (e.textAlign = Oi(v)),
                          Bi(v, t._pointLabelSizes[h], g),
                          Ri(e, t.pointLabels[h] || "", g, u.lineHeight);
                      }
                    }
                    e.restore();
                  })(t),
            ...
            l =
              ...
              (function(t, e, i, n) {
                ...
                for (a = qi.indexOf(t); a < s - 1; ++a)
                  if (
                    ((o = ji[qi[a]]),
                    (r = o.steps ? o.steps[o.steps.length - 1] : Hi),
        ...
        var Ji = fi.extend({
            ...
            getLabelWidth: function(t) {
              var e = this.options.ticks,
                ...
                a = Math.cos(n),
                o = Math.sin(n),
                r = Vi(e.fontSize, st.global.defaultFontSize);
              return i * a + r * o;
            },
                  ...
                  (function(t, i, n) {
                    if (!(isNaN(f) || f <= 0)) {
                      ...
                      if (
                        ...
                        d.setLineDash &&
                          d.setLineDash(cn(n.lineDash, o.borderDash)),
        ...
        function pn(t, e) {
          ...
          we.configure(t, i, e), we.addBox(t, i), (t.legend = i);
        }
        var mn = {
            id: "legend",
            _element: gn,
            ...
            beforeUpdate: function(t) {
              ...
              e
                ? (ut.mergeIf(e, st.global.legend),
                  i ? (we.configure(t, i, e), (i.options = e)) : pn(t, e))
                : i && (we.removeBox(t, i), delete t.legend);
            },
            ...
            beforeUpdate: function(t) {
              ...
              e
                ? (ut.mergeIf(e, st.global.title),
                  i ? (we.configure(t, i, e), (i.options = e)) : xn(t, e))
                : i && (we.removeBox(t, i), delete t.titleBlock);
            },
          };
        ...
        (function() {
          ...
          (ut.where = function(t, e) {
            ...
            (ut.getMaximumWidth = function(t) {
              ...
              var i = e.clientWidth,
                n = ut._calculatePadding(e, "padding-left", i),
                a = ut._calculatePadding(e, "padding-right", i),
                o = i - n - a,
            ...
            (ut.getMaximumHeight = function(t) {
              ...
              var i = e.clientHeight,
                n = ut._calculatePadding(e, "padding-top", i),
                a = ut._calculatePadding(e, "padding-bottom", i),
                o = i - n - a,
...
//# sourceMappingURL=chunk.9bf3f3abd70e120161cd.js.map
