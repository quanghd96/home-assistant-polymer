    ...
    450: function(e, t, i) {
      ...
      const o = {
        ...
        initializeStoredValue: function() {
          return this.isNew
            ...
            : this._getStoredValue("data").then(
                function(e) {
                  if ((this._log("Got stored value!", e, this.data), null == e))
        ...
        __dataChanged: function(e) {
          if (
            ...
            this._enqueueTransaction(function() {
              return (
                this._log("Setting", t + ":", a || i),
                a &&
                  this.__pathIsSplices(t) &&
                  ((t = this.__parentPath(t)), (i = this.get(t))),
                this._setStoredValue(t, i)
              );
            });
          }
        },
        __normalizeMemoryPath: function(e) {
          for (
            var t = e.split("."), i = [], a = [], n = [], r = 0;
            r < t.length;
            ++r
          )
            a.push(t[r]),
              /^#/.test(t[r])
                ? n.push(this.get(i).indexOf(this.get(a)))
                : n.push(t[r]),
              i.push(t[r]);
          return n.join(".");
        },
        ...
        __pathCanBeIgnored: function(e) {
          return n.test(e) && Array.isArray(this.get(this.__parentPath(e)));
        },
