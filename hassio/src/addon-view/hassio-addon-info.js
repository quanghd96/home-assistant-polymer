...
const PERMIS_DESC = {
  ...
  homeassistant_api: {
    title: "JAVIS Home API Access",
    description:
      "This add-on is allowed to access your running JAVIS Home instance directly via the JAVIS Home API. This mode handles authentication for the add-on as well, which enables an add-on to interact with JAVIS Home without the need for additional authentication tokens.",
  },
  full_access: {
  ...
  auth_api: {
    title: "JAVIS Home Authentication",
    description:
      "An add-on can authenticate users against JAVIS Home, allowing add-ons to give users the possibility to log into applications running inside add-ons, using their JAVIS Home username/password. This badge indicates if the add-on author requests this capability.",
  },
  ingress: {
    title: "Ingress",
    description:
      "This add-on is using Ingress to embed its interface securely into JAVIS Home.",
  },
};
            ...
            <template is="dom-if" if="[[addon.ingress]]">
              <div class="state">
                ...
                <template is="dom-if" if="[[_computeCannotIngressSidebar(hass, addon)]]">
                  <span>This option requires JAVIS Home 0.92 or later.</span>
                </template>
              </div>
            </template>
            <div class="state">
